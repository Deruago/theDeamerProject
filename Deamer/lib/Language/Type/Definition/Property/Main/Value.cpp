...
deamer::language::type::definition::property::main::Value::Value(std::vector<object::main::ValueObject*> valueObjects_, 
			std::vector<object::main::ValueAbstraction*> valueAbstractions_)
	: Definition(Type::Value),
	valueObjects(valueObjects_),
	valueAbstractions(valueAbstractions_)
{
	references.Add(valueObjects);
