...
deamer::ast::type::cpp::NodeIsDeleted::NodeIsDeleted(ReferenceType reference_)
	: reference(reference_),
	  languageName(reference_.GetDefinition<language::type::definition::property::Type::Identity>()
					   .GetName()
					   ->value)
{
	nodeIsDeletedTemplate = new ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate();
}

deamer::ast::type::cpp::NodeIsDeleted::~NodeIsDeleted()
{
	delete nodeIsDeletedTemplate;
}

deamer::file::tool::File deamer::ast::type::cpp::NodeIsDeleted::Generate() const
{
	deamer::file::tool::File nodeIsTerminal("NodeIsDeleted", "h");
