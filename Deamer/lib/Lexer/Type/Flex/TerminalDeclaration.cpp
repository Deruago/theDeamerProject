...
deamer::lexer::type::flex::TerminalDeclaration::TerminalDeclaration(
...
std::string deamer::lexer::type::flex::TerminalDeclaration::Generate() const
{
	return terminal.Name + '\t' + '(' + terminal.Regex + ')' + '\n';
}
