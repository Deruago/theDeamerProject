...
#ifndef DEAMER_AST_TYPE_CPP_RELATION_NODEISIGNORED_H
#define DEAMER_AST_TYPE_CPP_RELATION_NODEISIGNORED_H
...
namespace deamer::ast::type::cpp
{
	/*!	\class NodeIsIgnored
	 *
	 *	\brief Generates a compile relation header file for the relation: enum -> is ignored.
	 *
	...
	private:
		...
		templates::ast::type::cpp::NodeIsIgnoredTemplate* nodeIsDeletedTemplate;

	public:
		NodeIsIgnored(ReferenceType reference_);
		~NodeIsIgnored();
...
#endif // DEAMER_AST_TYPE_CPP_RELATION_NODEISIGNORED_H
