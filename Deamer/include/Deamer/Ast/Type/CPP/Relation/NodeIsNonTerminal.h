...
#ifndef DEAMER_AST_TYPE_CPP_RELATION_NODEISNONTERMINAL_H
#define DEAMER_AST_TYPE_CPP_RELATION_NODEISNONTERMINAL_H
...
{
	/*!	\class NodeIsNonTerminal
	 *
	 *	\brief Generates a compile relation header file for the relation: enum -> is nonterminal.
	 *
	...
	private:
		...
		templates::ast::type::cpp::NodeIsNonTerminalTemplate* nodeIsNonTerminalTemplate;

	public:
		NodeIsNonTerminal(ReferenceType reference_);
		~NodeIsNonTerminal();
...
#endif // DEAMER_AST_TYPE_CPP_RELATION_NODEISNONTERMINAL_H
