...
#ifndef DEAMER_AST_TYPE_CPP_RELATION_NODEISINLINED_H
#define DEAMER_AST_TYPE_CPP_RELATION_NODEISINLINED_H
...
namespace deamer::ast::type::cpp
{
	/*!	\class NodeIsInlined
	 *
	 *	\brief Generates a compile relation header file for the relation: enum -> is inlined.
	 *
	...
	private:
		...
		templates::ast::type::cpp::NodeIsInlinedTemplate* NodeIsInlinedTemplate;

	public:
		NodeIsInlined(ReferenceType reference_);
		~NodeIsInlined();
...
#endif // DEAMER_AST_TYPE_CPP_RELATION_NODEISINLINED_H
