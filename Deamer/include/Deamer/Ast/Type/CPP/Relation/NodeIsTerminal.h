...
#ifndef DEAMER_AST_TYPE_CPP_RELATION_NODEISTERMINAL_H
#define DEAMER_AST_TYPE_CPP_RELATION_NODEISTERMINAL_H
...
{
	/*!	\class NodeIsTerminal
	 *
	 *	\brief Generates a compile relation header file for the relation: enum -> is terminal.
	 *
	...
	private:
		...
		templates::ast::type::cpp::NodeIsTerminalTemplate* nodeIsTerminalTemplate;

	public:
		NodeIsTerminal(ReferenceType reference_);
		~NodeIsTerminal();
...
#endif // DEAMER_AST_TYPE_CPP_RELATION_NODEISTERMINAL_H
