...
#ifndef DEAMER_AST_TYPE_CPP_RELATION_NODEENUMTOTYPE_H
#define DEAMER_AST_TYPE_CPP_RELATION_NODEENUMTOTYPE_H
...
{
	/*!	\class NodeEnumToType
	 *
	 *	\brief Generates a compile relation header file for the relation: enum -> type.
	 *
	...
	private:
		...
		templates::ast::type::cpp::NodeEnumToTypeTemplate* nodeEnumToTypeTemplate;

	public:
		NodeEnumToType(ReferenceType reference_);
		~NodeEnumToType();
...
#endif // DEAMER_AST_TYPE_CPP_RELATION_NODEENUMTOTYPE_H
