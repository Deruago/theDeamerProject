...
#ifndef DEAMER_AST_TYPE_CPP_RELATION_NODETEXTTOENUM_H
#define DEAMER_AST_TYPE_CPP_RELATION_NODETEXTTOENUM_H
...
{
	/*!	\class NodeTextToEnum
	 *
	 *	\brief Generates a compile relation header file for the relation: text -> enum.
	 *
	...
	private:
		...
		templates::ast::type::cpp::NodeTextToEnumTemplate* nodeTextToEnumTemplate;

	public:
		NodeTextToEnum(ReferenceType reference_);
		~NodeTextToEnum();
...
#endif // DEAMER_AST_TYPE_CPP_RELATION_NODETEXTTOENUM_H
