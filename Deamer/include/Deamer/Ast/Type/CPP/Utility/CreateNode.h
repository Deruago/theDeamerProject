...
#ifndef DEAMER_AST_TYPE_CPP_UTILITY_CREATENODE_H
#define DEAMER_AST_TYPE_CPP_UTILITY_CREATENODE_H
...
#include "Deamer/Template/Ast/Type/CPP/Utility/CreateNode/CreateNodeTemplate.h"
...
namespace deamer::ast::type::cpp
{
	...
	private:
		...
		templates::ast::type::cpp::CreateNodeTemplate* createNodeTemplate;

	public:
		CreateNode(ReferenceType reference_);
		~CreateNode();
...
#endif // DEAMER_AST_TYPE_CPP_UTILITY_CREATENODE_H
