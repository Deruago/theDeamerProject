...
#ifndef DEAMER_TOOL_DLDLCONVERTOR_DLDLCONVERTOR_H
#define DEAMER_TOOL_DLDLCONVERTOR_DLDLCONVERTOR_H
...
namespace deamer::tool::type::dldlconverter
{
	/*!	\class DLDLConverter
	 *
	 *	\brief Uses the LD to generate a DLDL project.
	 *
	 *	\details This will ask for every LPD, as this serves as a generator for any main LPD.
	 */
	class DLDLConverter : public ::deamer::tool::type::Base
	{
	public:
	...
	public:
		DLDLConverter(reference reference_);
...
#endif // DEAMER_TOOL_DLDLCONVERTOR_DLDLCONVERTOR_H
