...
#ifndef DEAMER_TOOL_DEAMERDEFAULTAPPLICATION_DEAMERDEFAULTAPPLICATION_H
#define DEAMER_TOOL_DEAMERDEFAULTAPPLICATION_DEAMERDEFAULTAPPLICATION_H
...
{
	/*!	\class DeamerDefaultApplication
	 *
	 *	\brief Uses the LD to generate a default applications, which allow easier testing.
	 */
	class DeamerDefaultApplication : public ::deamer::tool::type::Base
	{
	public:
	...
	public:
		DeamerDefaultApplication(reference reference_);
...
#endif // DEAMER_TOOL_DEAMERDEFAULTAPPLICATION_DEAMERDEFAULTAPPLICATION_H
