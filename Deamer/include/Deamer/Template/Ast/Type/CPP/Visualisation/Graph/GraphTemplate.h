...
namespace deamer::templates::ast::type::cpp
{
	...
	public:
		...
		ConvertEnumToName(::deamer::templates::ast::type::cpp::GraphTemplate::Type enumerationValue)
		{
			...
			case ::deamer::templates::ast::type::cpp::GraphTemplate::Type::
				language_name_underscore_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::GraphTemplate::Type type =
				::deamer::templates::ast::type::cpp::GraphTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType scope_type_,
			...
			VariableScope(const char* text,
						  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Upper_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Lower_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Snake_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Slash_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::DoubleColon_,
					  true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::Variable_Field_,
				true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::GraphTemplate::ScopeType::
									  Variable_Field_Separator_,
								  true);
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			Variable_class_name_(GraphTemplate* graphtemplate_,
		...
		struct Variable_const_qualifier_ : public VariableScopes
		{
			...
			Variable_const_qualifier_(GraphTemplate* graphtemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::const_qualifier_;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(GraphTemplate* graphtemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(graphtemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(graphtemplate_->header_guard_->This()),
					 GenerateVariable("\n\n#include \""),
					 GenerateVariable(graphtemplate_->language_name_->This()),
					 ...
					 GenerateVariable("{"),
					 GenerateVariable(" namespace deamer "),
					 GenerateVariable("{"),
					 GenerateVariable(" namespace visualisation "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\t\tvoid AddConnection("),
					 GenerateVariable(graphtemplate_->const_qualifier_->This()),
					 GenerateVariable("  ::deamer::external::cpp::ast::Node* source, "),
					 GenerateVariable(graphtemplate_->const_qualifier_->This()),
					 GenerateVariable("  ::deamer::external::cpp::ast::Node* target)\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\toutput += \""),
					 GenerateVariable("\\"),
					 GenerateVariable("t\" + std::to_string(::std::size_t(source)) + \" -> \" + "
									  "std::to_string(::std::size_t(target)) + \";"),
					 GenerateVariable("\\"),
					 GenerateVariable("n\";\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\t\t"),
					 GenerateVariable(graphtemplate_->listen_object_entry_->Variable_Field()),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable(graphtemplate_->listen_object_exit_->Variable_Field()),
					 GenerateVariable("\n\n\tpublic:\n\t\tGraph()\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\tInit();\n\t\t"),
					 GenerateVariable("}"),
				...
				*static_cast<VariableBase*>(Class_postfix_) =
				...
				Class_postfix_->type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(graphtemplate_->class_name_->This())}));
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			Variable_header_guard_(GraphTemplate* graphtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::header_guard_;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(GraphTemplate* graphtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::language_name_;
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::
					language_name_underscore_;
			}

			virtual ~Variable_language_name_underscore_() override = default;

			Variable_language_name_underscore_(GraphTemplate* graphtemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(GraphTemplate* graphtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(GraphTemplate* graphtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(GraphTemplate* graphtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_listen_object_entry_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::listen_object_entry_;
			}

			virtual ~Variable_listen_object_entry_() override = default;

			Variable_listen_object_entry_(GraphTemplate* graphtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_listen_object_exit_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::listen_object_exit_;
			}

			virtual ~Variable_listen_object_exit_() override = default;

			Variable_listen_object_exit_(GraphTemplate* graphtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_object_ : public VariableScopes
		{
			...
			Variable_object_(GraphTemplate* graphtemplate_,
							 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::object_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(GraphTemplate* graphtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(GraphTemplate* graphtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::GraphTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::GraphTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(GraphTemplate* graphtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
	...
	public:
		...
		{
			*class_name_ =
				Variable_class_name_(this, std::vector<VariableBase*>({GenerateVariable("Graph")}));
			...
			*header_guard_ = Variable_header_guard_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(language_name_underscore_->Upper()),
						   GenerateVariable("_AST_VISUALISATION_"),
			...
			*left_curly_bracket_ = Variable_left_curly_bracket_(
				this, std::vector<VariableBase*>({GenerateVariable("(")}));
			*listen_object_entry_ = Variable_listen_object_entry_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\tvoid ListenEntry("),
					 ...
					 GenerateVariable(object_->This()),
					 GenerateVariable("* node) override\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\tfor ("),
					 GenerateVariable(const_qualifier_->This()),
					 GenerateVariable(" auto* child : node-"),
					 GenerateVariable(right_angle_bracket_->This()),
					 GenerateVariable("GetNodes())\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\t\tAddConnection(node, child);\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\t\t\toutput += \""),
					 GenerateVariable("\\"),
					 GenerateVariable("t\" + std::to_string(::std::size_t(node)) + \" [label="),
					 GenerateVariable("\\"),
					 GenerateVariable("\""),
					 GenerateVariable(object_->This()),
					 GenerateVariable("\\"),
