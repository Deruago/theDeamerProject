#ifndef DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISINLINEDTEMPLATE_h
#define DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISINLINEDTEMPLATE_h
...
{
	/*!	\class NodeIsInlinedTemplate
	 *
	 *	\brief Generates code for "NodeIsInlinedTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::class_name_: {
				return "class_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::is_inlined_: {
				return "is_inlined";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::language_name_: {
				return "language_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
				language_name_underscore_: {
			...
			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::left_bracket_: {
				return "left_bracket";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::node_name_: {
				return "node_name";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::right_bracket_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type type =
				::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType scope_type_,
				bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType::Upper_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType::Lower_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType::Snake_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType::Slash_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(nodeisinlinedtemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(nodeisinlinedtemplate_->header_guard_->This()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(nodeisinlinedtemplate_->node_enum_include_->This()),
					 GenerateVariable("\n\nnamespace "),
					 GenerateVariable(nodeisinlinedtemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable(nodeisinlinedtemplate_->class_name_->This()),
					 GenerateVariable("("),
					 GenerateVariable(nodeisinlinedtemplate_->node_enum_type_->This()),
					 GenerateVariable(" t)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable(nodeisinlinedtemplate_->node_conversion_->Variable_Field()),
					 GenerateVariable("\n\n\t\treturn false;\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\n"),
					 GenerateVariable("}}"),
					 ...
					 GenerateVariable(nodeisinlinedtemplate_->header_guard_->This())}));
				Content_->type =
					::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_is_inlined_ : public VariableScopes
		{
			static constexpr auto name = "is_inlined_";

			Variable_is_inlined_() : VariableScopes()
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::is_inlined_;
			}

			virtual ~Variable_is_inlined_() override = default;

			Variable_is_inlined_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
			...
			Variable_is_inlined_& operator=(const Variable_is_inlined_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
					language_name_;
			}

			virtual ~Variable_language_name_() override = default;

			Variable_language_name_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			Variable_language_name_underscore_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_node_conversion_ : public VariableScopes
		{
			...
			Variable_node_conversion_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_node_enum_include_ : public VariableScopes
		{
			...
			Variable_node_enum_include_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_node_enum_type_ : public VariableScopes
		{
			...
			Variable_node_enum_type_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_node_enum_value_type_ : public VariableScopes
		{
			...
			Variable_node_enum_value_type_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_node_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::node_name_;
			}

			virtual ~Variable_node_name_() override = default;

			Variable_node_name_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::node_name_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(NodeIsInlinedTemplate* nodeisinlinedtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsInlinedTemplate::Type::
	...
	public:
		...
		// e.g. NodeIsInlinedTemplate.member = "auto-generated";
		...
		Variable_is_inlined_* is_inlined_ = new Variable_is_inlined_();
	...
	public:
		NodeIsInlinedTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("NodeIsInlined")}));
			...
			*is_inlined_ = Variable_is_inlined_(this, std::vector<VariableBase*>({}));
			...
			*node_conversion_ = Variable_node_conversion_(
				...
				std::vector<VariableBase*>({GenerateVariable("\n\t\tif (t == "),
											...
											GenerateVariable(")\n\t\t"), GenerateVariable("{"),
											GenerateVariable("\n\t\t\treturn "),
											GenerateVariable(is_inlined_->This()),
											GenerateVariable(";\n\t\t"), GenerateVariable("}")}));
			...
			*right_curly_bracket_ = Variable_right_curly_bracket_(
			...
			variables_.emplace_back(is_inlined_);
...
#endif // DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISINLINEDTEMPLATE_h
