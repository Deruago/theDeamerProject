#ifndef DEAMER_TEMPLATES_AST_TYPE_CPP_NODETEXTTOENUMTEMPLATE_h
#define DEAMER_TEMPLATES_AST_TYPE_CPP_NODETEXTTOENUMTEMPLATE_h
...
{
	/*!	\class NodeTextToEnumTemplate
	 *
	 *	\brief Generates code for "NodeTextToEnumTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::class_name_: {
				return "class_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
				language_name_: {
			...
			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::left_bracket_: {
				return "left_bracket";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::node_name_: {
				return "node_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::node_type_: {
				return "node_type";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type type =
				::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::ScopeType scope_type_,
				bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 ...
					 GenerateVariable(nodetexttoenumtemplate_->node_enum_type_->This()),
					 GenerateVariable("> mapTextWithType = "),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\"\", "),
					 ...
					 GenerateVariable("}"),
					 GenerateVariable(",\n\t\t\t"),
					 GenerateVariable(nodetexttoenumtemplate_->node_conversion_->Variable_Field()),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable("}"),
					 ...
					 GenerateVariable(nodetexttoenumtemplate_->header_guard_->This())}));
				Content_->type =
					::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(nodetexttoenumtemplate_->class_name_->This())}));
				File_name_->type =
					::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
					header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			Variable_language_name_underscore_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_node_conversion_ : public VariableScopes
		{
			...
			Variable_node_conversion_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_node_enum_include_ : public VariableScopes
		{
			...
			Variable_node_enum_include_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_node_enum_type_ : public VariableScopes
		{
			...
			Variable_node_enum_type_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_node_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::node_name_;
			}

			virtual ~Variable_node_name_() override = default;

			Variable_node_name_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_node_type_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::node_type_;
			}

			virtual ~Variable_node_type_() override = default;

			Variable_node_type_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_node_type_include_ : public VariableScopes
		{
			...
			Variable_node_type_include_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(NodeTextToEnumTemplate* nodetexttoenumtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeTextToEnumTemplate::Type::
	...
	public:
		...
		// e.g. NodeTextToEnumTemplate.member = "auto-generated";
	...
	public:
		NodeTextToEnumTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("NodeTextToEnum")}));
		...
		virtual ~NodeTextToEnumTemplate()
		{
...
#endif // DEAMER_TEMPLATES_AST_TYPE_CPP_NODETEXTTOENUMTEMPLATE_h
