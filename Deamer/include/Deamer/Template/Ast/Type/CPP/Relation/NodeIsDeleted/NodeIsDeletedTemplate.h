#ifndef DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISDELETEDTEMPLATE_h
#define DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISDELETEDTEMPLATE_h
...
{
	/*!	\class NodeIsDeletedTemplate
	 *
	 *	\brief Generates code for "NodeIsDeletedTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::class_name_: {
				return "class_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::is_deleted_: {
				return "is_deleted";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::language_name_: {
				return "language_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
				language_name_underscore_: {
			...
			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::left_bracket_: {
				return "left_bracket";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::node_name_: {
				return "node_name";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::right_bracket_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type type =
				::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType scope_type_,
				bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType::Upper_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType::Lower_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType::Snake_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType::Slash_,
					  true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(nodeisdeletedtemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(nodeisdeletedtemplate_->header_guard_->This()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(nodeisdeletedtemplate_->node_enum_include_->This()),
					 GenerateVariable("\n\nnamespace "),
					 GenerateVariable(nodeisdeletedtemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable(nodeisdeletedtemplate_->class_name_->This()),
					 GenerateVariable("("),
					 GenerateVariable(nodeisdeletedtemplate_->node_enum_type_->This()),
					 GenerateVariable(" t)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable(nodeisdeletedtemplate_->node_conversion_->Variable_Field()),
					 GenerateVariable("\n\n\t\treturn false;\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\n"),
					 GenerateVariable("}}"),
					 ...
					 GenerateVariable(nodeisdeletedtemplate_->header_guard_->This())}));
				Content_->type =
					::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_is_deleted_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::is_deleted_;
			}

			virtual ~Variable_is_deleted_() override = default;

			Variable_is_deleted_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
					language_name_;
			}

			virtual ~Variable_language_name_() override = default;

			Variable_language_name_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			Variable_language_name_underscore_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_node_conversion_ : public VariableScopes
		{
			...
			Variable_node_conversion_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_node_enum_include_ : public VariableScopes
		{
			...
			Variable_node_enum_include_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_node_enum_type_ : public VariableScopes
		{
			...
			Variable_node_enum_type_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_node_enum_value_type_ : public VariableScopes
		{
			...
			Variable_node_enum_value_type_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_node_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::node_name_;
			}

			virtual ~Variable_node_name_() override = default;

			Variable_node_name_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::node_name_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(NodeIsDeletedTemplate* nodeisdeletedtemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsDeletedTemplate::Type::
	...
	public:
		...
		// e.g. NodeIsDeletedTemplate.member = "auto-generated";
	...
	public:
		NodeIsDeletedTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("NodeIsDeleted")}));
...
#endif // DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISDELETEDTEMPLATE_h
