...
namespace deamer::templates::ast::type::cpp
{
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type enumerationValue)
		{
			...
			case ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
				language_name_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type type =
				::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::ScopeType scope_type_,
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(nodeenumtotexttemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(nodeenumtotexttemplate_->header_guard_->This()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(nodeenumtotexttemplate_->node_enum_include_->This()),
					 GenerateVariable("\n\nnamespace "),
					 GenerateVariable(nodeenumtotexttemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable("{"),
					 GenerateVariable(" \n\n\tstatic constexpr const char* ConvertEnumToText("),
					 GenerateVariable(nodeenumtotexttemplate_->node_enum_type_->This()),
					 GenerateVariable(" type)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\tswitch(type)\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\t"),
					 GenerateVariable(nodeenumtotexttemplate_->node_conversion_->Variable_Field()),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\t\t\n\t\treturn \"\";\n\t"),
					 GenerateVariable("}"),
					 ...
					 GenerateVariable(nodeenumtotexttemplate_->header_guard_->This())}));
				Content_->type =
					::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(nodeenumtotexttemplate_->class_name_->This())}));
				File_name_->type =
					::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
					header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			Variable_language_name_underscore_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_node_conversion_ : public VariableScopes
		{
			...
			Variable_node_conversion_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_node_enum_include_ : public VariableScopes
		{
			...
			Variable_node_enum_include_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_node_enum_type_ : public VariableScopes
		{
			...
			Variable_node_enum_type_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_node_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::node_name_;
			}

			virtual ~Variable_node_name_() override = default;

			Variable_node_name_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_node_type_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::node_type_;
			}

			virtual ~Variable_node_type_() override = default;

			Variable_node_type_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_node_type_include_ : public VariableScopes
		{
			...
			Variable_node_type_include_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(NodeEnumToTextTemplate* nodeenumtotexttemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTextTemplate::Type::
	...
	public:
		NodeEnumToTextTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("NodeEnumToText")}));
			...
			*node_conversion_ = Variable_node_conversion_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("\n\tcase "), GenerateVariable(node_enum_type_->This()),
						   GenerateVariable("::"), GenerateVariable(node_name_->This()),
