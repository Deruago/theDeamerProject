#ifndef DEAMER_TEMPLATES_AST_TYPE_CPP_NODEENUMTOTYPETEMPLATE_h
#define DEAMER_TEMPLATES_AST_TYPE_CPP_NODEENUMTOTYPETEMPLATE_h
...
{
	/*!	\class NodeEnumToTypeTemplate
	 *
	 *	\brief Generates code for "NodeEnumToTypeTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::class_name_: {
				return "class_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
				language_name_: {
			...
			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::left_bracket_: {
				return "left_bracket";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::node_name_: {
				return "node_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::node_type_: {
				return "node_type";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type type =
				::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::ScopeType scope_type_,
				bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(nodeenumtotypetemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(nodeenumtotypetemplate_->header_guard_->This()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(nodeenumtotypetemplate_->node_enum_include_->This()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(
						 nodeenumtotypetemplate_->node_type_include_->Variable_Field()),
					 GenerateVariable("\n\nnamespace "),
					 GenerateVariable(nodeenumtotypetemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable("{"),
					 GenerateVariable(" \n\n\ttemplate<"),
					 GenerateVariable(nodeenumtotypetemplate_->node_enum_type_->This()),
					 GenerateVariable(" T>\n\tstruct "),
					 GenerateVariable(nodeenumtotypetemplate_->class_name_->This()),
					 GenerateVariable("\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable(
					 ...
					 GenerateVariable("}"),
					 GenerateVariable(";\n\n"),
					 GenerateVariable(nodeenumtotypetemplate_->node_conversion_->Variable_Field()),
					 GenerateVariable("\n\ntemplate<"),
					 GenerateVariable(nodeenumtotypetemplate_->node_enum_type_->This()),
					 ...
					 GenerateVariable(nodeenumtotypetemplate_->header_guard_->This())}));
				Content_->type =
					::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
					header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			Variable_language_name_underscore_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_node_conversion_ : public VariableScopes
		{
			...
			Variable_node_conversion_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_node_enum_include_ : public VariableScopes
		{
			...
			Variable_node_enum_include_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_node_enum_type_ : public VariableScopes
		{
			...
			Variable_node_enum_type_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_node_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::node_name_;
			}

			virtual ~Variable_node_name_() override = default;

			Variable_node_name_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_node_type_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::node_type_;
			}

			virtual ~Variable_node_type_() override = default;

			Variable_node_type_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_node_type_include_ : public VariableScopes
		{
			...
			Variable_node_type_include_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(NodeEnumToTypeTemplate* nodeenumtotypetemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeEnumToTypeTemplate::Type::
	...
	public:
		...
		// e.g. NodeEnumToTypeTemplate.member = "auto-generated";
	...
	public:
		NodeEnumToTypeTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("NodeEnumToType")}));
			...
			*node_conversion_ = Variable_node_conversion_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("\n\ttemplate"),
						   ...
						   GenerateVariable(left_angle_bracket_->This()),
						   GenerateVariable(node_enum_type_->This()),
						   GenerateVariable("::"),
		...
		virtual ~NodeEnumToTypeTemplate()
		{
...
#endif // DEAMER_TEMPLATES_AST_TYPE_CPP_NODEENUMTOTYPETEMPLATE_h
