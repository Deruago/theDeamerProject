#ifndef DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISTERMINALTEMPLATE_h
#define DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISTERMINALTEMPLATE_h
...
{
	/*!	\class NodeIsTerminalTemplate
	 *
	 *	\brief Generates code for "NodeIsTerminalTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::class_name_: {
				return "class_name";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::is_terminal_: {
				return "is_terminal";
			}

			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
				language_name_: {
			...
			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::left_bracket_: {
				return "left_bracket";
			}
			...
			case ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::node_name_: {
				return "node_name";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type type =
				::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::ScopeType scope_type_,
				bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(nodeisterminaltemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(nodeisterminaltemplate_->header_guard_->This()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(nodeisterminaltemplate_->node_enum_include_->This()),
					 GenerateVariable("\n\nnamespace "),
					 GenerateVariable(nodeisterminaltemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable(nodeisterminaltemplate_->class_name_->This()),
					 GenerateVariable("("),
					 GenerateVariable(nodeisterminaltemplate_->node_enum_type_->This()),
					 GenerateVariable(" t)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable(nodeisterminaltemplate_->node_conversion_->Variable_Field()),
					 GenerateVariable("\n\n\t\treturn false;\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\n"),
					 GenerateVariable("}}"),
					 ...
					 GenerateVariable(nodeisterminaltemplate_->header_guard_->This())}));
				Content_->type =
					::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
					header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_is_terminal_ : public VariableScopes
		{
			static constexpr auto name = "is_terminal_";

			Variable_is_terminal_() : VariableScopes()
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::is_terminal_;
			}

			virtual ~Variable_is_terminal_() override = default;

			Variable_is_terminal_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
			...
			Variable_is_terminal_& operator=(const Variable_is_terminal_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			Variable_language_name_underscore_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_node_conversion_ : public VariableScopes
		{
			...
			Variable_node_conversion_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_node_enum_include_ : public VariableScopes
		{
			...
			Variable_node_enum_include_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_node_enum_type_ : public VariableScopes
		{
			...
			Variable_node_enum_type_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_node_enum_value_type_ : public VariableScopes
		{
			...
			Variable_node_enum_value_type_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_node_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::node_name_;
			}

			virtual ~Variable_node_name_() override = default;

			Variable_node_name_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(NodeIsTerminalTemplate* nodeisterminaltemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::NodeIsTerminalTemplate::Type::
	...
	public:
		...
		// e.g. NodeIsTerminalTemplate.member = "auto-generated";
		...
		Variable_is_terminal_* is_terminal_ = new Variable_is_terminal_();
	...
	public:
		NodeIsTerminalTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("NodeIsTerminal")}));
			...
			*is_terminal_ = Variable_is_terminal_(this, std::vector<VariableBase*>({}));
			...
			*node_conversion_ = Variable_node_conversion_(
				...
				std::vector<VariableBase*>({GenerateVariable("\n\t\tif (t == "),
											...
											GenerateVariable(")\n\t\t"), GenerateVariable("{"),
											GenerateVariable("\n\t\t\treturn "),
											GenerateVariable(is_terminal_->This()),
											GenerateVariable(";\n\t\t"), GenerateVariable("}")}));
			...
			*right_curly_bracket_ = Variable_right_curly_bracket_(
			...
			variables_.emplace_back(is_terminal_);
		...
		virtual ~NodeIsTerminalTemplate()
		{
...
#endif // DEAMER_TEMPLATES_AST_TYPE_CPP_NODEISTERMINALTEMPLATE_h
