...
namespace deamer::templates::ast::type::cpp
{
	...
	public:
		enum class Type
		{
			...
			// User defined types
			const_qualifier_,
			dispatch_entry_nonterminal_case_,
			dispatch_entry_terminal_case_,
			dispatch_exit_nonterminal_case_,
			dispatch_exit_terminal_case_,
			...
			::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type enumerationValue)
		{
			...
			case ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
				dispatch_entry_nonterminal_case_: {
				return "dispatch_entry_nonterminal_case";
			}

			case ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
				dispatch_entry_terminal_case_: {
				return "dispatch_entry_terminal_case";
			}

			case ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
				dispatch_exit_nonterminal_case_: {
				return "dispatch_exit_nonterminal_case";
			}

			case ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
				dispatch_exit_terminal_case_: {
				return "dispatch_exit_terminal_case";
			}
	...
	public:
		...
		struct Variable_dispatch_entry_nonterminal_case_ : public VariableScopes
		{
			static constexpr auto name = "dispatch_entry_nonterminal_case_";

			Variable_dispatch_entry_nonterminal_case_() : VariableScopes()
			{
				type = ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
					dispatch_entry_nonterminal_case_;
			}

			virtual ~Variable_dispatch_entry_nonterminal_case_() override = default;

			Variable_dispatch_entry_nonterminal_case_(
			...
			Variable_dispatch_entry_nonterminal_case_&
			operator=(const Variable_dispatch_entry_nonterminal_case_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_dispatch_entry_terminal_case_ : public VariableScopes
		{
			static constexpr auto name = "dispatch_entry_terminal_case_";

			Variable_dispatch_entry_terminal_case_() : VariableScopes()
			{
				type = ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
					dispatch_entry_terminal_case_;
			}

			virtual ~Variable_dispatch_entry_terminal_case_() override = default;

			Variable_dispatch_entry_terminal_case_(
				EnterExitListenerTemplate* enterexitlistenertemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_dispatch_entry_terminal_case_&
			operator=(const Variable_dispatch_entry_terminal_case_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_dispatch_exit_nonterminal_case_ : public VariableScopes
		{
			static constexpr auto name = "dispatch_exit_nonterminal_case_";

			Variable_dispatch_exit_nonterminal_case_() : VariableScopes()
			{
				type = ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
					dispatch_exit_nonterminal_case_;
			}

			virtual ~Variable_dispatch_exit_nonterminal_case_() override = default;

			Variable_dispatch_exit_nonterminal_case_(
				EnterExitListenerTemplate* enterexitlistenertemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_dispatch_exit_nonterminal_case_&
			operator=(const Variable_dispatch_exit_nonterminal_case_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_dispatch_exit_terminal_case_ : public VariableScopes
		{
			static constexpr auto name = "dispatch_exit_terminal_case_";

			Variable_dispatch_exit_terminal_case_() : VariableScopes()
			{
				type = ::deamer::templates::ast::type::cpp::EnterExitListenerTemplate::Type::
					dispatch_exit_terminal_case_;
			}

			virtual ~Variable_dispatch_exit_terminal_case_() override = default;

			Variable_dispatch_exit_terminal_case_(
				EnterExitListenerTemplate* enterexitlistenertemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_dispatch_exit_terminal_case_&
			operator=(const Variable_dispatch_exit_terminal_case_& variable)
			{
				if (&variable == this)
				{
					return *this;
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 ...
					 GenerateVariable("."),
					 GenerateVariable("h>\n#include <Deamer/Algorithm/Tree/DFS"),
					 GenerateVariable("."),
					 GenerateVariable("h>\n\nnamespace "),
					 GenerateVariable(enterexitlistenertemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 ...
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\t// Terminal cases\n\t\t\t"),
					 GenerateVariable(enterexitlistenertemplate_->dispatch_entry_terminal_case_
										  ->Variable_Field()),
					 GenerateVariable("\n\n\t\t\t// Nonterminal cases\n\t\t\t"),
					 GenerateVariable(enterexitlistenertemplate_->dispatch_entry_nonterminal_case_
										  ->Variable_Field()),
					 GenerateVariable("\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\t\tvoid DispatchExit(const "
									  "::deamer::external::cpp::ast::Node* node) "),
					 GenerateVariable(enterexitlistenertemplate_->const_qualifier_->This()),
					 GenerateVariable("\n\t\t"),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\t\t// Terminal cases\n\t\t\t"),
					 GenerateVariable(enterexitlistenertemplate_->dispatch_exit_terminal_case_
										  ->Variable_Field()),
					 GenerateVariable("\n\n\t\t\t// Nonterminal cases\n\t\t\t"),
					 GenerateVariable(enterexitlistenertemplate_->dispatch_exit_nonterminal_case_
										  ->Variable_Field()),
					 GenerateVariable("\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\t\t"),
	...
	public:
		...
		Variable_dispatch_entry_nonterminal_case_* dispatch_entry_nonterminal_case_ =
			new Variable_dispatch_entry_nonterminal_case_();
		Variable_dispatch_entry_terminal_case_* dispatch_entry_terminal_case_ =
			new Variable_dispatch_entry_terminal_case_();
		Variable_dispatch_exit_nonterminal_case_* dispatch_exit_nonterminal_case_ =
			new Variable_dispatch_exit_nonterminal_case_();
		Variable_dispatch_exit_terminal_case_* dispatch_exit_terminal_case_ =
			new Variable_dispatch_exit_terminal_case_();
	...
	public:
		EnterExitListenerTemplate()
		{
			...
			*dispatch_entry_nonterminal_case_ = Variable_dispatch_entry_nonterminal_case_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\t\tcase "), GenerateVariable(language_type_->This()),
					 ...
					 GenerateVariable(nonterminal_node_->This()), GenerateVariable("*"),
					 GenerateVariable(right_angle_bracket_->This()),
					 GenerateVariable("(node));\n\t\t\t\tbreak;\n\t\t\t"), GenerateVariable("}")}));
			*dispatch_entry_terminal_case_ = Variable_dispatch_entry_terminal_case_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\t\tcase "), GenerateVariable(language_type_->This()),
					 ...
					 GenerateVariable(right_angle_bracket_->This()),
					 GenerateVariable("(node));\n\t\t\t\tbreak;\n\t\t\t"), GenerateVariable("}")}));
			*dispatch_exit_nonterminal_case_ = Variable_dispatch_exit_nonterminal_case_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\t\tcase "), GenerateVariable(language_type_->This()),
					 GenerateVariable("::"), GenerateVariable(nonterminal_name_->This()),
					 ...
					 GenerateVariable("(node));\n\t\t\t\tExitNonTerminal(node);"
									  "\n\t\t\t\tExitAnything(node);\n\t\t\t\tbreak;\n\t\t\t"),
					 GenerateVariable("}")}));
			*dispatch_exit_terminal_case_ = Variable_dispatch_exit_terminal_case_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\t\tcase "), GenerateVariable(language_type_->This()),
					 GenerateVariable("::"), GenerateVariable(terminal_name_->This()),
			...
			*exit_nonterminal_listen_ = Variable_exit_nonterminal_listen_(
				...
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\tvirtual void ListenExit(const "),
					 ...
					 GenerateVariable(const_qualifier_->This()), GenerateVariable("\n\t\t"),
					 GenerateVariable("{"), GenerateVariable("\n\t\t"), GenerateVariable("}")}));
			*exit_terminal_listen_ = Variable_exit_terminal_listen_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t\tvirtual void ListenExit(const "),
					 GenerateVariable(terminal_node_->This()), GenerateVariable("* node) "),
			...
			*terminal_node_ = Variable_terminal_node_(
			...
			variables_.emplace_back(dispatch_entry_nonterminal_case_);
			variables_.emplace_back(dispatch_entry_terminal_case_);
			variables_.emplace_back(dispatch_exit_nonterminal_case_);
			variables_.emplace_back(dispatch_exit_terminal_case_);
