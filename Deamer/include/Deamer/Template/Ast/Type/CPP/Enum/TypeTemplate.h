#ifndef DEAMER_TEMPLATES_AST_TYPE_CPP_TYPETEMPLATE_h
#define DEAMER_TEMPLATES_AST_TYPE_CPP_TYPETEMPLATE_h
...
namespace deamer::templates::ast::type::cpp
{
	/*!	\class TypeTemplate
	 *
	 *	\brief Generates code for "TypeTemplate"
	 *
	...
	public:
		enum class Type
		{
			...
			left_bracket_,
			left_curly_bracket_,
			nonterminal_enumeration_,
			right_angle_bracket_,
			right_bracket_,
			right_curly_bracket_,
			terminal_enumeration_,
		...
		ConvertEnumToName(::deamer::templates::ast::type::cpp::TypeTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::class_name_: {
				return "class_name";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::enum_name_: {
				return "enum_name";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::enumeration_: {
				return "enumeration";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::language_name_: {
				return "language_name";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::
				language_name_underscore_: {
				return "language_name_underscore";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_angle_bracket_: {
				return "left_angle_bracket";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_bracket_: {
				return "left_bracket";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_curly_bracket_: {
				return "left_curly_bracket";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::
				nonterminal_enumeration_: {
				return "nonterminal_enumeration";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_angle_bracket_: {
				return "right_angle_bracket";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_bracket_: {
				return "right_bracket";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_curly_bracket_: {
				return "right_curly_bracket";
			}

			case ::deamer::templates::ast::type::cpp::TypeTemplate::Type::terminal_enumeration_: {
				return "terminal_enumeration";
			}
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::ast::type::cpp::TypeTemplate::Type type =
				::deamer::templates::ast::type::cpp::TypeTemplate::Type::Unknown;
		...
		{
			::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType scope_type =
				::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Upper_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Lower_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Snake_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Slash_, true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::DoubleColon_,
					  true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::Variable_Field_,
				true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::ast::type::cpp::TypeTemplate::ScopeType::
									  Variable_Field_Separator_,
								  true);
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(TypeTemplate* typetemplate_,
		...
		struct Variable_enum_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::enum_name_;
			}

			virtual ~Variable_enum_name_() override = default;

			Variable_enum_name_(TypeTemplate* typetemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::enum_name_;
		...
		struct Variable_enumeration_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::enumeration_;
			}

			virtual ~Variable_enumeration_() override = default;

			Variable_enumeration_(TypeTemplate* typetemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::enumeration_;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(TypeTemplate* typetemplate_, const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(typetemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(typetemplate_->header_guard_->This()),
					 GenerateVariable("\n\n#include <cstddef>\n\nnamespace "),
					 GenerateVariable(typetemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable(typetemplate_->terminal_enumeration_->Variable_Field()),
					 GenerateVariable("\n\n\t\t// NonTerminal\n"),
					 GenerateVariable(typetemplate_->nonterminal_enumeration_->Variable_Field()),
					 GenerateVariable("\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\n\n\tstatic inline bool operator==(std::size_t lhs, ::"),
					 GenerateVariable(typetemplate_->language_name_->This()),
					 GenerateVariable("::ast::Type rhs)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\treturn lhs == static_cast<std::size_t>(rhs);\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\tstatic inline bool operator==(::"),
					 GenerateVariable(typetemplate_->language_name_->This()),
					 GenerateVariable("::ast::Type lhs, std::size_t rhs)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\treturn static_cast<std::size_t>(lhs) == rhs;\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\tstatic inline bool operator==(int lhs, ::"),
					 GenerateVariable(typetemplate_->language_name_->This()),
					 GenerateVariable("::ast::Type rhs)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\treturn lhs == static_cast<std::size_t>(rhs);\n\t"),
					 ...
					 GenerateVariable("\n\n\tstatic inline bool operator==(::"),
					 GenerateVariable(typetemplate_->language_name_->This()),
					 GenerateVariable("::ast::Type lhs, int rhs)\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\treturn static_cast<std::size_t>(lhs) == rhs;\n\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n"),
					 ...
					 GenerateVariable("\n\n#endif // "),
					 GenerateVariable(typetemplate_->header_guard_->This())}));
				Content_->type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_postfix_) =
					VariableBase(std::vector<VariableBase*>({}));
				Class_postfix_->type =
					::deamer::templates::ast::type::cpp::TypeTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("h")}));
				Extension_->type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(typetemplate_->class_name_->This())}));
				File_name_->type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("deamer::templates::ast::type::cpp")}));
				Namespace_->type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(TypeTemplate* typetemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::header_guard_;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::language_name_;
			}

			virtual ~Variable_language_name_() override = default;

			Variable_language_name_(TypeTemplate* typetemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::language_name_;
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::
					language_name_underscore_;
			}

			virtual ~Variable_language_name_underscore_() override = default;

			Variable_language_name_underscore_(TypeTemplate* typetemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(TypeTemplate* typetemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(TypeTemplate* typetemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(TypeTemplate* typetemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::left_curly_bracket_;
		...
		struct Variable_nonterminal_enumeration_ : public VariableScopes
		{
			static constexpr auto name = "nonterminal_enumeration_";

			Variable_nonterminal_enumeration_() : VariableScopes()
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::
					nonterminal_enumeration_;
			}

			virtual ~Variable_nonterminal_enumeration_() override = default;

			Variable_nonterminal_enumeration_(TypeTemplate* typetemplate_,
											  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::
			...
			Variable_nonterminal_enumeration_&
			operator=(const Variable_nonterminal_enumeration_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(TypeTemplate* typetemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(TypeTemplate* typetemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::ast::type::cpp::TypeTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(TypeTemplate* typetemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_terminal_enumeration_ : public VariableScopes
		{
			static constexpr auto name = "terminal_enumeration_";

			Variable_terminal_enumeration_() : VariableScopes()
			{
				type =
					::deamer::templates::ast::type::cpp::TypeTemplate::Type::terminal_enumeration_;
			}

			virtual ~Variable_terminal_enumeration_() override = default;

			Variable_terminal_enumeration_(TypeTemplate* typetemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
			...
			Variable_terminal_enumeration_&
			operator=(const Variable_terminal_enumeration_& variable)
			{
				if (&variable == this)
				{
					return *this;
	...
	public:
		...
		// e.g. TypeTemplate.member = "auto-generated";
		...
		Variable_nonterminal_enumeration_* nonterminal_enumeration_ =
			new Variable_nonterminal_enumeration_();
		...
		Variable_terminal_enumeration_* terminal_enumeration_ =
			new Variable_terminal_enumeration_();

	public:
		TypeTemplate()
		{
			*class_name_ =
				Variable_class_name_(this, std::vector<VariableBase*>({GenerateVariable("Type")}));
			*enum_name_ = Variable_enum_name_(this, std::vector<VariableBase*>({}));
			*enumeration_ = Variable_enumeration_(
				this, std::vector<VariableBase*>({GenerateVariable("\t\t"),
												  GenerateVariable(enum_name_->This()),
												  GenerateVariable(",")}));
			...
			*header_guard_ = Variable_header_guard_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(language_name_underscore_->Upper()),
						   GenerateVariable("_AST_ENUM_"), GenerateVariable(class_name_->Upper()),
						   GenerateVariable("_H")}));
			...
			*left_curly_bracket_ = Variable_left_curly_bracket_(
				this, std::vector<VariableBase*>({GenerateVariable("(")}));
			*nonterminal_enumeration_ = Variable_nonterminal_enumeration_(
				this, std::vector<VariableBase*>({GenerateVariable(enumeration_->This())}));
			...
			*right_curly_bracket_ = Variable_right_curly_bracket_(
				this, std::vector<VariableBase*>({GenerateVariable(")")}));
			*terminal_enumeration_ = Variable_terminal_enumeration_(
				this, std::vector<VariableBase*>({GenerateVariable(enumeration_->This())}));
			...
			variables_.emplace_back(nonterminal_enumeration_);
			...
			variables_.emplace_back(terminal_enumeration_);
		}
...
#endif // DEAMER_TEMPLATES_AST_TYPE_CPP_TYPETEMPLATE_h
