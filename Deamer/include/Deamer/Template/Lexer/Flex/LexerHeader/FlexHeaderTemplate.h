#ifndef DEAMER_TEMPLATES_FLEX_FLEXHEADERTEMPLATE_h
#define DEAMER_TEMPLATES_FLEX_FLEXHEADERTEMPLATE_h
...
{
	/*!	\class FlexHeaderTemplate
	 *
	 *	\brief Generates code for "FlexHeaderTemplate"
	 *
	...
	public:
		...
		ConvertEnumToName(::deamer::templates::flex::FlexHeaderTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::flex::FlexHeaderTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::header_guard_: {
				return "header_guard";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::language_name_: {
				return "language_name";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::left_angle_bracket_: {
				return "left_angle_bracket";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::left_bracket_: {
				return "left_bracket";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::left_curly_bracket_: {
				return "left_curly_bracket";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::right_angle_bracket_: {
				return "right_angle_bracket";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::right_bracket_: {
				return "right_bracket";
			}

			case ::deamer::templates::flex::FlexHeaderTemplate::Type::right_curly_bracket_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::flex::FlexHeaderTemplate::Type type =
				::deamer::templates::flex::FlexHeaderTemplate::Type::Unknown;
		...
		{
			::deamer::templates::flex::FlexHeaderTemplate::ScopeType scope_type =
				::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::flex::FlexHeaderTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::deamer::templates::flex::FlexHeaderTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Upper_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Lower_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Snake_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Slash_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(
					  ::deamer::templates::flex::FlexHeaderTemplate::ScopeType::DoubleColon_, true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope(
				"\n",
				::deamer::templates::flex::FlexHeaderTemplate::ScopeType::Variable_Field_Separator_,
				true);
	...
	public:
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(FlexHeaderTemplate* flexheadertemplate_,
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(flexheadertemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(flexheadertemplate_->header_guard_->This()),
					 GenerateVariable("\n\n#include <Deamer/External/Cpp/Lexer/Interface/Lexer"),
					 GenerateVariable("."),
					 GenerateVariable("h>\n\nnamespace "),
					 GenerateVariable(flexheadertemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 GenerateVariable(" namespace flex "),
					 GenerateVariable("{"),
					 GenerateVariable(" namespace lexer "),
					 GenerateVariable("{"),
					 GenerateVariable(
					 ...
					 GenerateVariable("\n\tpublic:\n\t\tLexer() = default;\n\t\t~Lexer() override "
									  ...
									  "Tokenize(const std::string& text) const override\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable(
						 "\n\t\t\treturn "
						 "::deamer::external::cpp::lexer::Lexer::Tokenize(text);\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n\t\tstd::vector<const "
									  "::deamer::external::cpp::lexer::TerminalObject*> "
					 ...
					 GenerateVariable(flexheadertemplate_->header_guard_->This()),
					 GenerateVariable("\n")}));
				Content_->type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_postfix_) =
					VariableBase(std::vector<VariableBase*>({}));
				Class_postfix_->type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("h")}));
				Extension_->type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("FlexHeader")}));
				File_name_->type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("deamer::templates::flex")}));
				Namespace_->type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;

				*static_cast<VariableBase*>(Target_language_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("C++")}));
				Target_language_->type = ::deamer::templates::flex::FlexHeaderTemplate::Type::Scope;
			}
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(FlexHeaderTemplate* flexheadertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::header_guard_;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::language_name_;
			}

			virtual ~Variable_language_name_() override = default;

			Variable_language_name_(FlexHeaderTemplate* flexheadertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::language_name_;
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(FlexHeaderTemplate* flexheadertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(FlexHeaderTemplate* flexheadertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(FlexHeaderTemplate* flexheadertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::left_curly_bracket_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(FlexHeaderTemplate* flexheadertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(FlexHeaderTemplate* flexheadertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(FlexHeaderTemplate* flexheadertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::flex::FlexHeaderTemplate::Type::right_curly_bracket_;
	...
	public:
		...
		// e.g. FlexHeaderTemplate.member = "auto-generated";
		...
		FlexHeaderTemplate()
		{
			...
			*header_guard_ = Variable_header_guard_(
				this, std::vector<VariableBase*>({GenerateVariable(language_name_->This()),
												  GenerateVariable("_FLEX_LEXER_H")}));
...
#endif // DEAMER_TEMPLATES_FLEX_FLEXHEADERTEMPLATE_h
