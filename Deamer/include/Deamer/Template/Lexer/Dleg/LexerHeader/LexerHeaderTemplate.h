#ifndef DEAMER_TEMPLATES_DLEG_LEXERHEADERTEMPLATE_h
#define DEAMER_TEMPLATES_DLEG_LEXERHEADERTEMPLATE_h
...
namespace deamer::templates::dleg
{
	...
	/*!	\class LexerHeaderTemplate
	 *
	 *	\brief Generates code for "LexerHeaderTemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::deamer::templates::dleg::LexerHeaderTemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::deamer::templates::dleg::LexerHeaderTemplate::Type::file_:
{
	return "file";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::header_guard_:
{
	return "header_guard";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::language_name_:
{
	return "language_name";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_curly_bracket_:
{
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::dleg::LexerHeaderTemplate::Type type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Unknown;
		...
		{
			::deamer::templates::dleg::LexerHeaderTemplate::ScopeType scope_type = ::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::deamer::templates::dleg::LexerHeaderTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::deamer::templates::dleg::LexerHeaderTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::deamer::templates::dleg::LexerHeaderTemplate::ScopeType::Variable_Field_Separator_, true);
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::file_;
}

virtual ~Variable_file_() override = default;

Variable_file_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::file_;
*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("#ifndef "), GenerateVariable(lexerheadertemplate_->header_guard_->This()), GenerateVariable("\n#define "), GenerateVariable(lexerheadertemplate_->header_guard_->This()), GenerateVariable("\n\n#include <Deamer/External/Cpp/Lexer/Interface/Lexer"), GenerateVariable("."), GenerateVariable("h>\n\nnamespace "), GenerateVariable(lexerheadertemplate_->language_name_->This()), GenerateVariable(" "), GenerateVariable("{"), GenerateVariable(" namespace dleg "), GenerateVariable("{"), GenerateVariable(" namespace lexer "), GenerateVariable("{"), GenerateVariable("\n\n\tclass Lexer : public ::deamer::external::cpp::lexer::Lexer\n\t"), GenerateVariable("{"), GenerateVariable("\n\tpublic:\n\t\tLexer() = default;\n\t\t~Lexer() override = default;\n\t\n\tpublic:\n\t\tstd::vector<const ::deamer::external::cpp::lexer::TerminalObject*> Tokenize(const std::string& text) const override\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\treturn this->::deamer::external::cpp::lexer::Lexer::Tokenize(text);\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\tstd::vector<const ::deamer::external::cpp::lexer::TerminalObject*> Tokenize(const std::string& text, ::deamer::external::cpp::lexer::TerminalConstructionPolicy constructionPolicy) const override;\n\t"), GenerateVariable("}"), GenerateVariable(";\n\n"), GenerateVariable("}}"), GenerateVariable("}"), GenerateVariable("\n\n#endif // "), GenerateVariable(lexerheadertemplate_->header_guard_->This()), GenerateVariable("\n") }));
Content_->type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;

*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
Class_postfix_->type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;

*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
Extension_->type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;

*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("LexerHeader") }));
File_name_->type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;

*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("deamer::templates::dleg") }));
Namespace_->type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::Scope;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::header_guard_;
}

virtual ~Variable_header_guard_() override = default;

Variable_header_guard_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::header_guard_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::language_name_;
}

virtual ~Variable_language_name_() override = default;

Variable_language_name_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::language_name_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_angle_bracket_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_bracket_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::left_curly_bracket_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_angle_bracket_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_bracket_;
...
{
	type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(LexerHeaderTemplate* lexerheadertemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::dleg::LexerHeaderTemplate::Type::right_curly_bracket_;
...
Variable_right_curly_bracket_& operator=(const Variable_right_curly_bracket_& variable)
{
	...
	public:
		...
		// e.g. LexerHeaderTemplate.member = "auto-generated";
...
*header_guard_ = Variable_header_guard_(this, std::vector<VariableBase*>({ GenerateVariable(language_name_->This()), GenerateVariable("_DLEG_LEXER_H") }));
...
#endif // DEAMER_TEMPLATES_DLEG_LEXERHEADERTEMPLATE_h
