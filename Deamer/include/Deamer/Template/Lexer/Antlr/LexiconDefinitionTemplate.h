...
namespace deamer::templates::antlr::lexer
{
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type enumerationValue)
		{
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type type =
				::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Unknown;
		...
		{
			::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType scope_type =
				::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType scope_type_,
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::
	...
	public:
		struct Variable_crash_terminal_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
					crash_terminal_;
			}

			virtual ~Variable_crash_terminal_() override = default;

			Variable_crash_terminal_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
		...
		struct Variable_deleted_terminal_ : public VariableScopes
		{
			...
			Variable_deleted_terminal_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("lexer grammar "),
					 GenerateVariable(lexicondefinitiontemplate_->language_name_->This()),
					 GenerateVariable("Lexer;\n\n"),
					 GenerateVariable(
						 lexicondefinitiontemplate_->terminal_declaration_->Variable_Field())}));
				Content_->type =
					::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("LexiconDefinition")}));
				File_name_->type =
					::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("deamer::templates::antlr::lexer")}));
				Namespace_->type =
					::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_standard_terminal_ : public VariableScopes
		{
			...
			Variable_standard_terminal_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_terminal_declaration_ : public VariableScopes
		{
			...
			Variable_terminal_declaration_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_terminal_name_ : public VariableScopes
		{
			...
			Variable_terminal_name_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
		...
		struct Variable_terminal_regex_ : public VariableScopes
		{
			...
			Variable_terminal_regex_(LexiconDefinitionTemplate* lexicondefinitiontemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::
