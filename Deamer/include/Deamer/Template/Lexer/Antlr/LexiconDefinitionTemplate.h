#ifndef DEAMER_TEMPLATES_ANTLR_LEXER_LEXICONDEFINITIONTEMPLATE_h
#define DEAMER_TEMPLATES_ANTLR_LEXER_LEXICONDEFINITIONTEMPLATE_h

#include <variant>
#include <vector>
#include <string>

namespace deamer::templates::antlr::lexer
{

	/*!	\class LexiconDefinitionTemplate
	 *
	 *	\brief Generates code for "LexiconDefinitionTemplate"
	 *
...
Function_Field_Separator_,
		...
		static constexpr const char* ConvertEnumToName(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type enumerationValue)
{
	switch(enumerationValue)
	{
	case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::crash_terminal_:
{
	return "crash_terminal";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::deleted_terminal_:
{
	return "deleted_terminal";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::file_:
{
	return "file";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::language_name_:
{
	return "language_name";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_angle_bracket_:
{
	return "left_angle_bracket";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_bracket_:
{
	return "left_bracket";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_curly_bracket_:
{
	return "left_curly_bracket";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_angle_bracket_:
{
	return "right_angle_bracket";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_bracket_:
{
	return "right_bracket";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_curly_bracket_:
{
	return "right_curly_bracket";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::standard_terminal_:
{
	return "standard_terminal";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_declaration_:
{
	return "terminal_declaration";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_name_:
{
	return "terminal_name";
}

case ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_regex_:
{
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Unknown;
		...
		{
			::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType scope_type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;
			}
		};
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Upper_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Lower_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Snake_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Slash_, true),
			  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			: VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::DoubleColon_, true),
			  base(base_)
			{
			}
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::ScopeType::Variable_Field_Separator_, true);
...
struct Variable_crash_terminal_ : public VariableScopes
{

static constexpr auto name = "crash_terminal_";



Variable_crash_terminal_() : VariableScopes()
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::crash_terminal_;
}

virtual ~Variable_crash_terminal_() override = default;

Variable_crash_terminal_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::crash_terminal_;
...
Variable_crash_terminal_& operator=(const Variable_crash_terminal_& variable)
{
	if (&variable == this)
	{
		return *this;
...
struct Variable_deleted_terminal_ : public VariableScopes
{

static constexpr auto name = "deleted_terminal_";



Variable_deleted_terminal_() : VariableScopes()
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::deleted_terminal_;
}

virtual ~Variable_deleted_terminal_() override = default;

Variable_deleted_terminal_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::deleted_terminal_;
...
Variable_deleted_terminal_& operator=(const Variable_deleted_terminal_& variable)
{
	if (&variable == this)
	{
		return *this;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::file_;
}

virtual ~Variable_file_() override = default;

Variable_file_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::file_;
*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("lexer grammar "), GenerateVariable(lexicondefinitiontemplate_->language_name_->This()), GenerateVariable("Lexer;\n\n"), GenerateVariable(lexicondefinitiontemplate_->terminal_declaration_->Variable_Field()) }));
Content_->type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;

*static_cast<VariableBase*>(Class_postfix_) = VariableBase(std::vector<VariableBase*>({  }));
Class_postfix_->type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;

*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
Extension_->type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;

*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("LexiconDefinition") }));
File_name_->type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;

*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("deamer::templates::antlr::lexer") }));
Namespace_->type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;

*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
Target_language_->type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::Scope;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::language_name_;
}

virtual ~Variable_language_name_() override = default;

Variable_language_name_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::language_name_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_angle_bracket_;
}

virtual ~Variable_left_angle_bracket_() override = default;

Variable_left_angle_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_angle_bracket_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_bracket_;
}

virtual ~Variable_left_bracket_() override = default;

Variable_left_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_bracket_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_curly_bracket_;
}

virtual ~Variable_left_curly_bracket_() override = default;

Variable_left_curly_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::left_curly_bracket_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_angle_bracket_;
}

virtual ~Variable_right_angle_bracket_() override = default;

Variable_right_angle_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_angle_bracket_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_bracket_;
}

virtual ~Variable_right_bracket_() override = default;

Variable_right_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_bracket_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_curly_bracket_;
}

virtual ~Variable_right_curly_bracket_() override = default;

Variable_right_curly_bracket_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::right_curly_bracket_;
...
struct Variable_standard_terminal_ : public VariableScopes
{

static constexpr auto name = "standard_terminal_";



Variable_standard_terminal_() : VariableScopes()
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::standard_terminal_;
}

virtual ~Variable_standard_terminal_() override = default;

Variable_standard_terminal_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::standard_terminal_;
...
Variable_standard_terminal_& operator=(const Variable_standard_terminal_& variable)
{
	if (&variable == this)
	{
		return *this;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_declaration_;
}

virtual ~Variable_terminal_declaration_() override = default;

Variable_terminal_declaration_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_declaration_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_name_;
}

virtual ~Variable_terminal_name_() override = default;

Variable_terminal_name_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_name_;
...
{
	type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_regex_;
}

virtual ~Variable_terminal_regex_() override = default;

Variable_terminal_regex_(LexiconDefinitionTemplate* lexicondefinitiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
{
type = ::deamer::templates::antlr::lexer::LexiconDefinitionTemplate::Type::terminal_regex_;
...
Variable_terminal_regex_& operator=(const Variable_terminal_regex_& variable)
{
	...
	public:
		...
		// e.g. LexiconDefinitionTemplate.member = "auto-generated";
		Variable_crash_terminal_* crash_terminal_ = new Variable_crash_terminal_();
Variable_deleted_terminal_* deleted_terminal_ = new Variable_deleted_terminal_();
...
Variable_standard_terminal_* standard_terminal_ = new Variable_standard_terminal_();
...
Variable_terminal_regex_* terminal_regex_ = new Variable_terminal_regex_();
	...
	public:
		LexiconDefinitionTemplate()
		{
			*crash_terminal_ = Variable_crash_terminal_(this, std::vector<VariableBase*>({ GenerateVariable(terminal_name_->This()), GenerateVariable(": '"), GenerateVariable(terminal_regex_->This()), GenerateVariable("';") }));
*deleted_terminal_ = Variable_deleted_terminal_(this, std::vector<VariableBase*>({ GenerateVariable(terminal_name_->This()), GenerateVariable(": '"), GenerateVariable(terminal_regex_->This()), GenerateVariable("' -"), GenerateVariable(right_angle_bracket_->This()), GenerateVariable(" skip;") }));
...
*standard_terminal_ = Variable_standard_terminal_(this, std::vector<VariableBase*>({ GenerateVariable(terminal_name_->This()), GenerateVariable(": '"), GenerateVariable(terminal_regex_->This()), GenerateVariable("';") }));
*terminal_declaration_ = Variable_terminal_declaration_(this, std::vector<VariableBase*>({  }));
...
*terminal_regex_ = Variable_terminal_regex_(this, std::vector<VariableBase*>({  }));
			...
			variables_.emplace_back(crash_terminal_);
variables_.emplace_back(deleted_terminal_);
...
variables_.emplace_back(standard_terminal_);
...
variables_.emplace_back(terminal_regex_);
		...
		virtual ~LexiconDefinitionTemplate()
		{
...
#endif // DEAMER_TEMPLATES_ANTLR_LEXER_LEXICONDEFINITIONTEMPLATE_h
