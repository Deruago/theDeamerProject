#ifndef DEAMER_TEMPLATES_TOOL_DEAMERDEFAULTAPPLICATION_ASTVIEWER_ASTVIEWERTEMPLATE_h
#define DEAMER_TEMPLATES_TOOL_DEAMERDEFAULTAPPLICATION_ASTVIEWER_ASTVIEWERTEMPLATE_h

#include <string>
#include <variant>
#include <vector>

namespace deamer::templates::tool::deamerdefaultapplication::astviewer
{
	/*!	\class AstViewerTemplate
	 *
	 *	\brief Generates code for "AstViewerTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::tool::deamerdefaultapplication::astviewer::AstViewerTemplate::Type
				enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::tool::deamerdefaultapplication::astviewer::AstViewerTemplate::
				Type::class_name_: {
				return "class_name";
			}
			...
			case ::deamer::templates::tool::deamerdefaultapplication::astviewer::AstViewerTemplate::
				Type::language_name_underscore_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::tool::deamerdefaultapplication::astviewer::AstViewerTemplate::Type
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::Unknown;
		...
		{
			::deamer::templates::tool::deamerdefaultapplication::astviewer::AstViewerTemplate::
				ScopeType scope_type = ::deamer::templates::tool::deamerdefaultapplication::
					astviewer::AstViewerTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
							  AstViewerTemplate::ScopeType scope_type_,
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::deamer::templates::tool::deamerdefaultapplication::astviewer::
							  AstViewerTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									AstViewerTemplate::ScopeType::Upper_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									AstViewerTemplate::ScopeType::Lower_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									AstViewerTemplate::ScopeType::Snake_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									AstViewerTemplate::ScopeType::Slash_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									AstViewerTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ =
				new VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									  AstViewerTemplate::ScopeType::Default_,
								  true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::tool::deamerdefaultapplication::astviewer::
									  AstViewerTemplate::ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::tool::deamerdefaultapplication::astviewer::
									  AstViewerTemplate::ScopeType::Variable_Field_Separator_,
								  true);
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(AstViewerTemplate* astviewertemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(AstViewerTemplate* astviewertemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#include \""),
					 ...
					 GenerateVariable("/Ast/Visualisation/Graph"),
					 GenerateVariable("."),
					 GenerateVariable("h\"\n#include \""),
					 GenerateVariable(astviewertemplate_->language_name_->This()),
					 GenerateVariable("/"),
					 GenerateVariable(astviewertemplate_->parser_->This()),
					 ...
					 GenerateVariable(astviewertemplate_->language_name_->This()),
					 GenerateVariable(
						 "::ast::listener::deamer::visualisation::Graph();\n\t\t\tgraph"),
					 GenerateVariable("."),
					 GenerateVariable("Dispatch(ast->GetStartNode());\n\t\t\tstd::cout << graph"),
					 GenerateVariable("."),
					 GenerateVariable("GetGraph() << std::endl;\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\t\tdelete ast;\n\t"),
					 GenerateVariable("}"),
					 ...
					 GenerateVariable("n\";\n\treturn 0;\n"),
					 GenerateVariable("}")}));
				Content_->type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(Class_postfix_) =
				...
				Class_postfix_->type = ::deamer::templates::tool::deamerdefaultapplication::
					astviewer::AstViewerTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("h")}));
				Extension_->type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(astviewertemplate_->class_name_->This())}));
				File_name_->type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable(
						"deamer::templates::tool::deamerdefaultapplication::astviewer")}));
				Namespace_->type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::Scope;
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::language_name_;
			}

			virtual ~Variable_language_name_() override = default;

			Variable_language_name_(AstViewerTemplate* astviewertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_language_name_underscore_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::language_name_underscore_;
			}

			virtual ~Variable_language_name_underscore_() override = default;

			Variable_language_name_underscore_(AstViewerTemplate* astviewertemplate_,
											   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(AstViewerTemplate* astviewertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(AstViewerTemplate* astviewertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(AstViewerTemplate* astviewertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_parser_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::parser_;
			}

			virtual ~Variable_parser_() override = default;

			Variable_parser_(AstViewerTemplate* astviewertemplate_,
							 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(AstViewerTemplate* astviewertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(AstViewerTemplate* astviewertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
					AstViewerTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(AstViewerTemplate* astviewertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::tool::deamerdefaultapplication::astviewer::
	...
	public:
		...
		// e.g. AstViewerTemplate.member = "auto-generated";
	...
	public:
		AstViewerTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable("AstViewer")}));
			...
			*left_curly_bracket_ = Variable_left_curly_bracket_(
				this, std::vector<VariableBase*>({GenerateVariable("(")}));
			*parser_ = Variable_parser_(this, std::vector<VariableBase*>({}));
...
#endif // DEAMER_TEMPLATES_TOOL_DEAMERDEFAULTAPPLICATION_ASTVIEWER_ASTVIEWERTEMPLATE_h
