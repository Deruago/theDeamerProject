#ifndef DEAMER_TEMPLATES_CMAKE_MISCEL_STANDARD_SOURCEFILETEMPLATE_h
#define DEAMER_TEMPLATES_CMAKE_MISCEL_STANDARD_SOURCEFILETEMPLATE_h
...
namespace deamer::templates::cmake::miscel::standard
{
	 ...
	 *
	 *	\brief Generates code for "SourceFileTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
				const_qualifier_: {
				return "const_qualifier";
			}

			case ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::file_: {
				return "file";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type type =
				::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::Unknown;
		...
		{
			::deamer::templates::cmake::miscel::standard::SourceFileTemplate::ScopeType scope_type =
				::deamer::templates::cmake::miscel::standard::SourceFileTemplate::ScopeType::
					Unknown;
			...
			{
				type =
					::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::cmake::miscel::standard::SourceFileTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ =
				new VariableScope(::deamer::templates::cmake::miscel::standard::SourceFileTemplate::
									  ScopeType::Default_,
								  true);
	...
	public:
		struct Variable_const_qualifier_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
					const_qualifier_;
			}

			virtual ~Variable_const_qualifier_() override = default;

			Variable_const_qualifier_(SourceFileTemplate* sourcefiletemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(SourceFileTemplate* sourcefiletemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#include \""),
					 GenerateVariable(sourcefiletemplate_->languageName_->This()),
					 GenerateVariable("/"),
					 GenerateVariable(sourcefiletemplate_->languageName_->This()),
					 GenerateVariable("."),
				...
				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("SourceFile")}));
				File_name_->type =
					::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::Scope;
		...
		struct Variable_languageName_ : public VariableScopes
		{
			...
			Variable_languageName_(SourceFileTemplate* sourcefiletemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(SourceFileTemplate* sourcefiletemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(SourceFileTemplate* sourcefiletemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(SourceFileTemplate* sourcefiletemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(SourceFileTemplate* sourcefiletemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(SourceFileTemplate* sourcefiletemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(SourceFileTemplate* sourcefiletemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::miscel::standard::SourceFileTemplate::Type::
	...
	public:
		...
		// e.g. SourceFileTemplate.member = "auto-generated";
...
#endif // DEAMER_TEMPLATES_CMAKE_MISCEL_STANDARD_SOURCEFILETEMPLATE_h
