#ifndef DEAMER_TEMPLATES_CMAKE_MULTI_MAIN_DEFAULTDEAMERTEMPLATE_h
#define DEAMER_TEMPLATES_CMAKE_MULTI_MAIN_DEFAULTDEAMERTEMPLATE_h

#include <string>
#include <variant>
#include <vector>

namespace deamer::templates::cmake::multi::main
{
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::
				CMAKE_VAR_INTRO_: {
			...
			case ::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::file_: {
				return "file";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type type =
				::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::Unknown;
		...
		{
			::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::ScopeType scope_type =
				::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::ScopeType
							  scope_type_,
			...
			{
				type = ::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::ScopeType
							  scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::
	...
	public:
		struct Variable_CMAKE_VAR_INTRO_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::
					CMAKE_VAR_INTRO_;
			}
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::file_;
			}
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("# This file is auto-generated and auto-maintained"),
					 ...
					 GenerateVariable(")\nendfunction()\n")}));
				Content_->type =
					::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("deamer::templates::cmake::multi::main")}));
				Namespace_->type =
					::deamer::templates::cmake::multi::main::DefaultDeamerTemplate::Type::Scope;
...
#endif // DEAMER_TEMPLATES_CMAKE_MULTI_MAIN_DEFAULTDEAMERTEMPLATE_h
