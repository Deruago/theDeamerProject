#ifndef DEAMER_TEMPLATES_CMAKE_MULTI_MAIN_DEFAULTUSERTEMPLATE_h
#define DEAMER_TEMPLATES_CMAKE_MULTI_MAIN_DEFAULTUSERTEMPLATE_h
...
{
	/*!	\class DefaultUserTemplate
	 *
	 *	\brief Generates code for "DefaultUserTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
				CMAKE_VAR_INTRO_: {
			...
			case ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::file_: {
				return "file";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type type =
				::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::Unknown;
		...
		{
			::deamer::templates::cmake::multi::main::DefaultUserTemplate::ScopeType scope_type =
				::deamer::templates::cmake::multi::main::DefaultUserTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::cmake::multi::main::DefaultUserTemplate::ScopeType scope_type_,
				bool isReserved_ = false)
				: VariableBase(),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::cmake::multi::main::DefaultUserTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::cmake::multi::main::DefaultUserTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::cmake::multi::main::DefaultUserTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::cmake::multi::main::DefaultUserTemplate::
	...
	public:
		struct Variable_CMAKE_VAR_INTRO_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
					CMAKE_VAR_INTRO_;
			}

			virtual ~Variable_CMAKE_VAR_INTRO_() override = default;

			Variable_CMAKE_VAR_INTRO_(DefaultUserTemplate* defaultusertemplate_,
		...
		struct Variable_const_qualifier_ : public VariableScopes
		{
			...
			Variable_const_qualifier_(DefaultUserTemplate* defaultusertemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(DefaultUserTemplate* defaultusertemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("cmake_minimum_required(VERSION 3"), GenerateVariable("."),
					 GenerateVariable("16)\n\nproject("),
					 GenerateVariable(defaultusertemplate_->languageName_->This()),
					 GenerateVariable(
						 ")\n\nfind_package(Deamer_External "
						 "REQUIRED)\nfind_package(Deamer_Algorithm REQUIRED)\n\ninclude(deamer"),
					 GenerateVariable("."),
					 GenerateVariable("cmake)\n\nadd_subdirectory(extern)\nadd_subdirectory(lib)"
									  "\n\noption(TESTS \"Enables all the tests\" "
									  "ON)\nif(TESTS)\n\tmessage(STATUS \"Tests are now available"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "\")\n\tadd_subdirectory(tests)\nendif()\n\noption(APPLICATIONS \"Enables "
						 "all the applications\" ON)\nif(APPLICATIONS)\n\tmessage(STATUS "
						 "\"Applications are now available"),
					 GenerateVariable("."),
					 GenerateVariable("\")\n\tadd_subdirectory(sources)\nendif()\n")}));
				Content_->type =
					::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("DefaultUser")}));
				File_name_->type =
					::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::Scope;
		...
		struct Variable_languageName_ : public VariableScopes
		{
			...
			Variable_languageName_(DefaultUserTemplate* defaultusertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(DefaultUserTemplate* defaultusertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(DefaultUserTemplate* defaultusertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(DefaultUserTemplate* defaultusertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(DefaultUserTemplate* defaultusertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(DefaultUserTemplate* defaultusertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(DefaultUserTemplate* defaultusertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::cmake::multi::main::DefaultUserTemplate::Type::
	...
	public:
		...
		// e.g. DefaultUserTemplate.member = "auto-generated";
...
#endif // DEAMER_TEMPLATES_CMAKE_MULTI_MAIN_DEFAULTUSERTEMPLATE_h
