...
namespace deamer::templates::bison::parser
{
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::bison::parser::ParserDefinitionTemplate::Type enumerationValue)
		{
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::bison::parser::ParserDefinitionTemplate::Type type =
				::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::Unknown;
		...
		{
			::deamer::templates::bison::parser::ParserDefinitionTemplate::ScopeType scope_type =
				::deamer::templates::bison::parser::ParserDefinitionTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(
				::deamer::templates::bison::parser::ParserDefinitionTemplate::ScopeType scope_type_,
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::bison::parser::ParserDefinitionTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::bison::parser::ParserDefinitionTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::bison::parser::ParserDefinitionTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::bison::parser::ParserDefinitionTemplate::
	...
	public:
		struct Variable_extended_error_ : public VariableScopes
		{
			...
			Variable_extended_error_(ParserDefinitionTemplate* parserdefinitiontemplate_,
		...
		struct Variable_file_ : public VariableScopes
		{
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(parserdefinitiontemplate_->optional_extended_error_->This()),
					 GenerateVariable("\n"),
					 GenerateVariable(parserdefinitiontemplate_->optional_parse_lac_->This()),
					 GenerateVariable("\n"),
					 GenerateVariable(parserdefinitiontemplate_->optional_glr_setting_->This()),
					 GenerateVariable("\n\n%"),
					 GenerateVariable("{"),
					 GenerateVariable("\n#include <iostream>\n#include <vector>\n#include "
									  "<cstring>\n#include <stdio"),
					 ...
					 GenerateVariable("/Bison/Parser"),
					 GenerateVariable("."),
					 GenerateVariable("h\"\n#define YY_NO_UNISTD_H\n#include \"Flex/"),
					 GenerateVariable(parserdefinitiontemplate_->language_name_->This()),
					 GenerateVariable("_lexer"),
					 GenerateVariable("."),
					 ...
					 GenerateVariable("h\"\n"),
					 GenerateVariable(
						 parserdefinitiontemplate_->terminal_include_->Variable_Field()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(
						 parserdefinitiontemplate_->nonterminal_include_->Variable_Field()),
					 GenerateVariable("\n\n#ifndef YY_parse_NERRS\n#define YY_parse_NERRS "),
					 GenerateVariable(parserdefinitiontemplate_->language_name_->This()),
					 GenerateVariable("nerrs\n#endif //YY_parse_NERRS\n#ifndef "
					 ...
					 GenerateVariable("\n\n"),
					 GenerateVariable(
						 parserdefinitiontemplate_->terminal_declaration_->Variable_Field()),
					 GenerateVariable("\n\n"),
					 GenerateVariable(
					 ...
					 GenerateVariable(
						 parserdefinitiontemplate_->union_declaration_->Variable_Field()),
					 GenerateVariable("\n"),
					 GenerateVariable("}"),
					 GenerateVariable("\n\n%%\n\n"),
					 GenerateVariable(
						 parserdefinitiontemplate_->nonterminal_implementation_->Variable_Field()),
					 GenerateVariable("\n\n%%\n\nvoid "),
					 GenerateVariable(parserdefinitiontemplate_->language_name_->This()),
					 GenerateVariable("error(const char* s)\n"),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable(parserdefinitiontemplate_->language_name_->This()),
					 GenerateVariable("_delete_buffer(buf);\n\t"),
					 GenerateVariable(parserdefinitiontemplate_->language_name_->This()),
					 GenerateVariable("lex_destroy();\n\n\treturn outputTree;\n"),
					 GenerateVariable("}"),
					 GenerateVariable("\n")}));
				Content_->type =
					::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::Scope;
		...
		struct Variable_glr_setting_ : public VariableScopes
		{
			...
			Variable_glr_setting_(ParserDefinitionTemplate* parserdefinitiontemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_ignore_section_ : public VariableScopes
		{
			...
			Variable_ignore_section_(ParserDefinitionTemplate* parserdefinitiontemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_nonterminal_implementation_ : public VariableScopes
		{
			...
			Variable_nonterminal_implementation_(
			...
			Variable_nonterminal_implementation_&
			operator=(const Variable_nonterminal_implementation_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_nonterminal_include_ : public VariableScopes
		{
			...
			Variable_nonterminal_include_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_nonterminal_token_name_ : public VariableScopes
		{
			...
			Variable_nonterminal_token_name_(ParserDefinitionTemplate* parserdefinitiontemplate_,
											 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
			...
			Variable_nonterminal_token_name_&
			operator=(const Variable_nonterminal_token_name_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_optional_comma_ : public VariableScopes
		{
			...
			Variable_optional_comma_(ParserDefinitionTemplate* parserdefinitiontemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_optional_extended_error_ : public VariableScopes
		{
			...
			Variable_optional_extended_error_(ParserDefinitionTemplate* parserdefinitiontemplate_,
											  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
			...
			Variable_optional_extended_error_&
			operator=(const Variable_optional_extended_error_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_optional_glr_setting_ : public VariableScopes
		{
			...
			Variable_optional_glr_setting_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
			...
			Variable_optional_glr_setting_&
			operator=(const Variable_optional_glr_setting_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_optional_or_ : public VariableScopes
		{
			...
			Variable_optional_or_(ParserDefinitionTemplate* parserdefinitiontemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_optional_parse_lac_ : public VariableScopes
		{
			...
			Variable_optional_parse_lac_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_optional_top_nonterminal_output_ : public VariableScopes
		{
			...
			Variable_optional_top_nonterminal_output_(
				ParserDefinitionTemplate* parserdefinitiontemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_optional_top_nonterminal_output_&
			operator=(const Variable_optional_top_nonterminal_output_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_or_ : public VariableScopes
		{
			...
			Variable_or_(ParserDefinitionTemplate* parserdefinitiontemplate_,
						 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::or_;
		...
		struct Variable_parse_lac_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::parse_lac_;
			}

			virtual ~Variable_parse_lac_() override = default;

			Variable_parse_lac_(ParserDefinitionTemplate* parserdefinitiontemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_production_rule_implementation_ : public VariableScopes
		{
			...
			Variable_production_rule_implementation_(
				ParserDefinitionTemplate* parserdefinitiontemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_production_rule_implementation_&
			operator=(const Variable_production_rule_implementation_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_production_rule_index_ : public VariableScopes
		{
			...
			Variable_production_rule_index_(ParserDefinitionTemplate* parserdefinitiontemplate_,
											const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
			...
			Variable_production_rule_index_&
			operator=(const Variable_production_rule_index_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_production_rule_retrieved_tokens_ : public VariableScopes
		{
			...
			Variable_production_rule_retrieved_tokens_(
				ParserDefinitionTemplate* parserdefinitiontemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_production_rule_retrieved_tokens_&
			operator=(const Variable_production_rule_retrieved_tokens_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_production_rule_retrieved_tokens_impl_ : public VariableScopes
		{
			...
			Variable_production_rule_retrieved_tokens_impl_(
				ParserDefinitionTemplate* parserdefinitiontemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_production_rule_retrieved_tokens_impl_&
			operator=(const Variable_production_rule_retrieved_tokens_impl_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_terminal_declaration_ : public VariableScopes
		{
			...
			Variable_terminal_declaration_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_terminal_include_ : public VariableScopes
		{
			...
			Variable_terminal_include_(ParserDefinitionTemplate* parserdefinitiontemplate_,
									   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_token_index_ : public VariableScopes
		{
			...
			Variable_token_index_(ParserDefinitionTemplate* parserdefinitiontemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_token_name_ : public VariableScopes
		{
			...
			{
				type =
					::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::token_name_;
			}

			virtual ~Variable_token_name_() override = default;

			Variable_token_name_(ParserDefinitionTemplate* parserdefinitiontemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
		...
		struct Variable_top_nonterminal_output_ : public VariableScopes
		{
			...
			Variable_top_nonterminal_output_(ParserDefinitionTemplate* parserdefinitiontemplate_,
											 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
			...
			Variable_top_nonterminal_output_&
			operator=(const Variable_top_nonterminal_output_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_transfer_nonterminal_ : public VariableScopes
		{
			...
			Variable_transfer_nonterminal_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
			...
			Variable_transfer_nonterminal_&
			operator=(const Variable_transfer_nonterminal_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_transfer_terminal_ : public VariableScopes
		{
			...
			Variable_transfer_terminal_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
		...
		struct Variable_union_declaration_ : public VariableScopes
		{
			...
			Variable_union_declaration_(ParserDefinitionTemplate* parserdefinitiontemplate_,
										const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::bison::parser::ParserDefinitionTemplate::Type::
	...
	public:
		...
		Variable_nonterminal_implementation_* nonterminal_implementation_ =
			new Variable_nonterminal_implementation_();
		...
		Variable_optional_glr_setting_* optional_glr_setting_ =
			new Variable_optional_glr_setting_();
		...
		Variable_optional_top_nonterminal_output_* optional_top_nonterminal_output_ =
			new Variable_optional_top_nonterminal_output_();
		...
		Variable_production_rule_implementation_* production_rule_implementation_ =
			new Variable_production_rule_implementation_();
		Variable_production_rule_index_* production_rule_index_ =
			new Variable_production_rule_index_();
		Variable_production_rule_retrieved_tokens_* production_rule_retrieved_tokens_ =
			new Variable_production_rule_retrieved_tokens_();
		Variable_production_rule_retrieved_tokens_impl_* production_rule_retrieved_tokens_impl_ =
			new Variable_production_rule_retrieved_tokens_impl_();
		...
		Variable_top_nonterminal_output_* top_nonterminal_output_ =
			new Variable_top_nonterminal_output_();
		Variable_transfer_nonterminal_* transfer_nonterminal_ =
			new Variable_transfer_nonterminal_();
		...
		ParserDefinitionTemplate()
		{
			*extended_error_ = Variable_extended_error_(
				this, std::vector<VariableBase*>({GenerateVariable("%define parse"),
												  GenerateVariable("."),
												  GenerateVariable("error verbose")}));
			*file_ = Variable_file_(this, std::vector<VariableBase*>({}));
			*glr_setting_ = Variable_glr_setting_(
				this, std::vector<VariableBase*>({GenerateVariable("%glr-parser")}));
			*ignore_section_ = Variable_ignore_section_(
				this, std::vector<VariableBase*>({GenerateVariable("\n\t\tdelete $"),
												  GenerateVariable(token_index_->This()),
												  GenerateVariable(";")}));
			...
			*nonterminal_declaration_ = Variable_nonterminal_declaration_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("%nterm<"), GenerateVariable(language_name_->This()),
						   GenerateVariable("_"), GenerateVariable(token_name_->This()),
						   GenerateVariable("> "), GenerateVariable(token_name_->This())}));
			*nonterminal_implementation_ = Variable_nonterminal_implementation_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n"), GenerateVariable(nonterminal_token_name_->This()),
					 GenerateVariable(":"), GenerateVariable(production_rule_->Variable_Field()),
					 GenerateVariable("\n;\n")}));
			*nonterminal_include_ = Variable_nonterminal_include_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("#include \""), GenerateVariable(language_name_->This()),
					 GenerateVariable("/Ast/Node/"), GenerateVariable(token_name_->This()),
			...
			*optional_glr_setting_ =
				Variable_optional_glr_setting_(this, std::vector<VariableBase*>({}));
			*optional_or_ = Variable_optional_or_(this, std::vector<VariableBase*>({}));
			*optional_parse_lac_ = Variable_optional_parse_lac_(
				this, std::vector<VariableBase*>({GenerateVariable(parse_lac_->This())}));
			*optional_top_nonterminal_output_ =
				Variable_optional_top_nonterminal_output_(this, std::vector<VariableBase*>({}));
			*or_ = Variable_or_(this, std::vector<VariableBase*>({GenerateVariable("| ")}));
			*parse_lac_ = Variable_parse_lac_(
				this,
				std::vector<VariableBase*>({GenerateVariable("%define parse"),
											GenerateVariable("."), GenerateVariable("lac full")}));
			*production_rule_ = Variable_production_rule_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("\n\t"),
					 GenerateVariable(optional_or_->This()),
					 GenerateVariable(production_rule_implementation_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 GenerateVariable("\n\t\tauto* const newNode = new "),
					 ...
					 GenerateVariable(nonterminal_token_name_->This()),
					 GenerateVariable(", ::deamer::external::cpp::ast::NodeValue::nonterminal, "),
					 GenerateVariable("{"),
					 GenerateVariable(" "),
					 GenerateVariable(production_rule_index_->This()),
					 GenerateVariable(", ::deamer::external::cpp::ast::ProductionRuleType::"),
					 GenerateVariable(production_rule_type_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("}}"),
					 GenerateVariable(", "),
					 GenerateVariable("{"),
					 GenerateVariable(" "),
					 GenerateVariable(production_rule_retrieved_tokens_->Variable_Field()),
					 GenerateVariable(" "),
					 GenerateVariable("}"),
					 GenerateVariable(
						 ");\n\t\t$$ = newNode;\n\n\t\t// Ignored, Deleted, tokens are deleted"),
					 GenerateVariable(ignore_section_->Variable_Field()),
					 GenerateVariable(optional_top_nonterminal_output_->This()),
					 GenerateVariable("\n\t"),
					 GenerateVariable("}")}));
			*production_rule_implementation_ =
				Variable_production_rule_implementation_(this, std::vector<VariableBase*>({}));
			*production_rule_index_ =
				Variable_production_rule_index_(this, std::vector<VariableBase*>({}));
			*production_rule_retrieved_tokens_ = Variable_production_rule_retrieved_tokens_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(optional_comma_->This()),
						   GenerateVariable(production_rule_retrieved_tokens_impl_->This())}));
			*production_rule_retrieved_tokens_impl_ =
				Variable_production_rule_retrieved_tokens_impl_(this,
																std::vector<VariableBase*>({}));
			*production_rule_type_ =
			...
			*terminal_declaration_ = Variable_terminal_declaration_(
				this, std::vector<VariableBase*>({GenerateVariable("%token<Terminal> "),
												  GenerateVariable(token_name_->This())}));
			...
			*top_nonterminal_output_ = Variable_top_nonterminal_output_(
				this, std::vector<VariableBase*>({GenerateVariable(
						  "\n\t\toutputTree = new ::deamer::external::cpp::ast::Tree(newNode);")}));
			*transfer_nonterminal_ = Variable_transfer_nonterminal_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("$"), GenerateVariable(token_index_->This())}));
			*transfer_terminal_ = Variable_transfer_terminal_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("new "), GenerateVariable(language_name_->This()),
					 GenerateVariable("::ast::node::"), GenerateVariable(token_name_->This()),
					 GenerateVariable("("), GenerateVariable("{"), GenerateVariable("::"),
					 GenerateVariable(language_name_->This()), GenerateVariable("::ast::Type::"),
					 GenerateVariable(token_name_->This()),
					 GenerateVariable(", ::deamer::external::cpp::ast::NodeValue::terminal, $"),
					 GenerateVariable(token_index_->This()), GenerateVariable(" "),
					 GenerateVariable("}"), GenerateVariable(")")}));
			*union_declaration_ = Variable_union_declaration_(
				this, std::vector<VariableBase*>(
