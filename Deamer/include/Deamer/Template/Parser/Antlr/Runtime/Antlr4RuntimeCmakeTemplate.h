#ifndef DEAMER_TEMPLATES_ANTLR_PARSER_ANTLR4RUNTIMECMAKETEMPLATE_h
#define DEAMER_TEMPLATES_ANTLR_PARSER_ANTLR4RUNTIMECMAKETEMPLATE_h
...
{
	/*!	\class Antlr4RuntimeCmakeTemplate
	 *
	 *	\brief Generates code for "Antlr4RuntimeCmakeTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::Unknown: {
				return "Unknown";
			}

			case ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::Scope: {
				return "Scope";
			}

			case ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
				left_angle_bracket_: {
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type type =
				::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::Unknown;
		...
		{
			::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::ScopeType scope_type =
				::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::ScopeType
							  scope_type_,
			...
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::ScopeType
							  scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::
	...
	public:
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable(
						 "set(ANTLR_VERSION "
						 "@ANTLR_VERSION@)\n\n@PACKAGE_INIT@\n\nset_and_check(ANTLR4_INCLUDE_DIR "
						 "\"@PACKAGE_ANTLR4_INCLUDE_DIR@\")\nset_and_check(ANTLR4_LIB_DIR "
						 "\"@PACKAGE_ANTLR4_LIB_DIR@\")\n\ninclude(CMakeFindDependencyMacro)\nfind_"
						 "dependency(Threads)\n\ninclude($"),
					 GenerateVariable("{"), GenerateVariable("CMAKE_CURRENT_LIST_DIR"),
					 GenerateVariable("}"), GenerateVariable("/@targets_export_name@"),
					 GenerateVariable("."),
					 GenerateVariable("cmake)\n\ncheck_required_components(antlr)\n")}));
				Content_->type =
					::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("Antlr4RuntimeCmake")}));
				File_name_->type =
					::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::Scope;
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
					left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(Antlr4RuntimeCmakeTemplate* antlr4runtimecmaketemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::Antlr4RuntimeCmakeTemplate::Type::
	...
	public:
		...
		// e.g. Antlr4RuntimeCmakeTemplate.member = "auto-generated";
	...
	public:
		...
		virtual ~Antlr4RuntimeCmakeTemplate()
		{
...
#endif // DEAMER_TEMPLATES_ANTLR_PARSER_ANTLR4RUNTIMECMAKETEMPLATE_h
