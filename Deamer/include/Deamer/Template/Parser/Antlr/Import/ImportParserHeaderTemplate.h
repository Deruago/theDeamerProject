#ifndef DEAMER_TEMPLATES_ANTLR_PARSER_IMPORTPARSERHEADERTEMPLATE_h
#define DEAMER_TEMPLATES_ANTLR_PARSER_IMPORTPARSERHEADERTEMPLATE_h
...
{
	/*!	\class ImportParserHeaderTemplate
	 *
	 *	\brief Generates code for "ImportParserHeaderTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(
			::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::Unknown: {
				return "Unknown";
			}

			case ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::Scope: {
				return "Scope";
			}

			case ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::file_: {
				return "file";
			}

			case ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
				header_guard_: {
				return "header_guard";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type type =
				::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::Unknown;
		...
		{
			::deamer::templates::antlr::parser::ImportParserHeaderTemplate::ScopeType scope_type =
				::deamer::templates::antlr::parser::ImportParserHeaderTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::deamer::templates::antlr::parser::ImportParserHeaderTemplate::ScopeType
							  scope_type_,
			...
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::Scope;
			}

			VariableScope(const char* text,
						  ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::ScopeType
							  scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::ImportParserHeaderTemplate::
									ScopeType::Upper_,
								true),
				  base(base_)
			{
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::deamer::templates::antlr::parser::ImportParserHeaderTemplate::ScopeType::Default_,
				true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::antlr::parser::ImportParserHeaderTemplate::
									  ScopeType::Variable_Field_,
								  true);
			VariableBase* variable_field_separator_ =
				new VariableScope("\n",
								  ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::
	...
	public:
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(ImportParserHeaderTemplate* importparserheadertemplate_,
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(importparserheadertemplate_->header_guard_->This()),
					 GenerateVariable("\n#define "),
					 GenerateVariable(importparserheadertemplate_->header_guard_->This()),
					 ...
					 GenerateVariable("."),
					 GenerateVariable("h>\n#include <optional>\n#include <vector>\n\nnamespace "),
					 GenerateVariable(importparserheadertemplate_->language_name_->This()),
					 GenerateVariable(" "),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable("\n")}));
				Content_->type =
					::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::Scope;
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("ImportParserHeader")}));
				File_name_->type =
					::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
					header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(ImportParserHeaderTemplate* importparserheadertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(ImportParserHeaderTemplate* importparserheadertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			Variable_left_angle_bracket_(ImportParserHeaderTemplate* importparserheadertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(ImportParserHeaderTemplate* importparserheadertemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			Variable_left_curly_bracket_(ImportParserHeaderTemplate* importparserheadertemplate_,
										 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			Variable_right_angle_bracket_(ImportParserHeaderTemplate* importparserheadertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(ImportParserHeaderTemplate* importparserheadertemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			Variable_right_curly_bracket_(ImportParserHeaderTemplate* importparserheadertemplate_,
										  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ImportParserHeaderTemplate::Type::
	...
	public:
		...
		// e.g. ImportParserHeaderTemplate.member = "auto-generated";
	...
	public:
		ImportParserHeaderTemplate()
		{
			*file_ = Variable_file_(this, std::vector<VariableBase*>({}));
			*header_guard_ = Variable_header_guard_(
				this, std::vector<VariableBase*>({GenerateVariable(language_name_->Upper()),
												  GenerateVariable("_ANTLR_PARSER_PARSER_H")}));
		...
		virtual ~ImportParserHeaderTemplate()
		{
...
#endif // DEAMER_TEMPLATES_ANTLR_PARSER_IMPORTPARSERHEADERTEMPLATE_h
