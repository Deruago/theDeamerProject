#ifndef DEAMER_TEMPLATES_ANTLR_PARSER_LISTENERTRANSLATESOURCETEMPLATE_h
#define DEAMER_TEMPLATES_ANTLR_PARSER_LISTENERTRANSLATESOURCETEMPLATE_h
...
{
	/*!	\class ListenerTranslateSourceTemplate
	 *
	 *	\brief Generates code for "ListenerTranslateSourceTemplate"
	 *
	...
	public:
		...
		ConvertEnumToName(::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type
							  enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::
				Unknown: {
				return "Unknown";
			}

			case ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::Scope: {
				return "Scope";
			}

			case ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::file_: {
				return "file";
			}
	...
	public:
		struct VariableBase
		{
			...
			::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type type =
				::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::Unknown;
		...
		{
			::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::ScopeType
				scope_type = ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::
					ScopeType::Unknown;
			...
			{
				type = ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::
					Scope;
			}
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::
									ListenerTranslateSourceTemplate::ScopeType::Upper_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::
									ListenerTranslateSourceTemplate::ScopeType::Lower_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::
									ListenerTranslateSourceTemplate::ScopeType::Snake_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::
									ListenerTranslateSourceTemplate::ScopeType::Slash_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::deamer::templates::antlr::parser::
									ListenerTranslateSourceTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ =
				new VariableScope(::deamer::templates::antlr::parser::
									  ListenerTranslateSourceTemplate::ScopeType::Default_,
								  true);
			...
			VariableBase* variable_field_ =
				new VariableScope(::deamer::templates::antlr::parser::
									  ListenerTranslateSourceTemplate::ScopeType::Variable_Field_,
								  true);
	...
	public:
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(ListenerTranslateSourceTemplate* listenertranslatesourcetemplate_,
				...
				: VariableScopes(variables)
			{
				...
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#include \"ListenerTranslate"),
					 GenerateVariable("."),
					 GenerateVariable("h\"\n#include \"antlr4-runtime"),
					 GenerateVariable("."),
					 GenerateVariable("h\"\n#include \""),
					 GenerateVariable(listenertranslatesourcetemplate_->language_name_->This()),
					 ...
					 GenerateVariable("h\"\n#include \""),
					 GenerateVariable(listenertranslatesourcetemplate_->language_name_->This()),
					 GenerateVariable("/Antlr_Parser/Parser"),
					 GenerateVariable("."),
					 ...
					 GenerateVariable("."),
					 GenerateVariable("h>\n#include <optional>\n#include <vector>\n\n// As the "
									  "parser header requires the extern headers, this is "
									  "implemented in a private extern class"),
					 GenerateVariable("."),
					 GenerateVariable("\ndeamer::external::cpp::ast::Tree* "),
					 GenerateVariable(listenertranslatesourcetemplate_->language_name_->This()),
					 GenerateVariable(
						 "::antlr::parser::Parser::Parse(const std::string& text) const\n"),
					 GenerateVariable("{"),
					 ...
					 GenerateVariable(listenertranslatesourcetemplate_->language_name_->This()),
					 GenerateVariable(
						 "Parser parser(&tokens);\n\n\tantlr4::tree::ParseTree *tree = parser"),
					 GenerateVariable("."),
					 GenerateVariable(listenertranslatesourcetemplate_->start_nonterminal_->This()),
					 GenerateVariable(
						 "();\n\tListenerTranslate "
						 "listener(&tokens);\n\tantlr4::tree::ParseTreeWalker::DEFAULT"),
					 GenerateVariable("."),
					 GenerateVariable("walk(&listener, tree);\n\treturn listener"),
					 GenerateVariable("."),
					 GenerateVariable("GetTree();\n"),
					 GenerateVariable("}")}));
				Content_->type = ::deamer::templates::antlr::parser::
					ListenerTranslateSourceTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_postfix_) =
					VariableBase(std::vector<VariableBase*>({}));
				Class_postfix_->type = ::deamer::templates::antlr::parser::
					ListenerTranslateSourceTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("h")}));
				Extension_->type = ::deamer::templates::antlr::parser::
					ListenerTranslateSourceTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("ListenerTranslateSource")}));
				File_name_->type = ::deamer::templates::antlr::parser::
					ListenerTranslateSourceTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("deamer::templates::antlr::parser")}));
				Namespace_->type = ::deamer::templates::antlr::parser::
					ListenerTranslateSourceTemplate::Type::Scope;

				*static_cast<VariableBase*>(Target_language_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("C++")}));
				Target_language_->type = ::deamer::templates::antlr::parser::
					ListenerTranslateSourceTemplate::Type::Scope;
			}
		...
		struct Variable_language_name_ : public VariableScopes
		{
			...
			Variable_language_name_(
				ListenerTranslateSourceTemplate* listenertranslatesourcetemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::
		...
		struct Variable_start_nonterminal_ : public VariableScopes
		{
			static constexpr auto name = "start_nonterminal_";

			Variable_start_nonterminal_() : VariableScopes()
			{
				type = ::deamer::templates::antlr::parser::ListenerTranslateSourceTemplate::Type::
					start_nonterminal_;
			}

			virtual ~Variable_start_nonterminal_() override = default;

			Variable_start_nonterminal_(
				ListenerTranslateSourceTemplate* listenertranslatesourcetemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_start_nonterminal_& operator=(const Variable_start_nonterminal_& variable)
			{
				if (&variable == this)
				{
					return *this;
	...
	public:
		...
		// e.g. ListenerTranslateSourceTemplate.member = "auto-generated";
		...
		Variable_start_nonterminal_* start_nonterminal_ = new Variable_start_nonterminal_();

	public:
		ListenerTranslateSourceTemplate()
		{
			...
			*right_curly_bracket_ = Variable_right_curly_bracket_(
				this, std::vector<VariableBase*>({GenerateVariable(")")}));
			*start_nonterminal_ = Variable_start_nonterminal_(this, std::vector<VariableBase*>({}));
			...
			variables_.emplace_back(start_nonterminal_);
		}

		virtual ~ListenerTranslateSourceTemplate()
		{
...
#endif // DEAMER_TEMPLATES_ANTLR_PARSER_LISTENERTRANSLATESOURCETEMPLATE_h
