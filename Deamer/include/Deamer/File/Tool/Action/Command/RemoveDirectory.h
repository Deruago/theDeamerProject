...
#ifndef DEAMER_FILE_TOOL_ACTION_COMMAND_REMOVEDIRECTORY_H
#define DEAMER_FILE_TOOL_ACTION_COMMAND_REMOVEDIRECTORY_H
...
namespace deamer::file::tool::action
{
	...
	public:
		RemoveDirectory(const std::string& lhsPath_);
		virtual ~RemoveDirectory() override = default;
...
#endif // DEAMER_FILE_TOOL_ACTION_COMMAND_REMOVEDIRECTORY_H
