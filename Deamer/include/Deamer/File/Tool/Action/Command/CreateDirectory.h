...
#ifndef DEAMER_FILE_TOOL_ACTION_COMMAND_CREATEDIRECTORY_H
#define DEAMER_FILE_TOOL_ACTION_COMMAND_CREATEDIRECTORY_H
...
namespace deamer::file::tool::action
{
	...
	public:
		CreateDirectory(const std::string& lhsPath_);
		virtual ~CreateDirectory() override = default;
...
#endif // DEAMER_FILE_TOOL_ACTION_COMMAND_CREATEDIRECTORY_H
