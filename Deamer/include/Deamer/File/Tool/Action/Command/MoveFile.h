...
#ifndef DEAMER_FILE_TOOL_ACTION_COMMAND_MOVEFILE_H
#define DEAMER_FILE_TOOL_ACTION_COMMAND_MOVEFILE_H
...
namespace deamer::file::tool::action
{
	...
	public:
		MoveFile(const std::string& lhsPath_, const std::string& rhsPath_);
		virtual ~MoveFile() override = default;
...
#endif // DEAMER_FILE_TOOL_ACTION_COMMAND_MOVEFILE_H
