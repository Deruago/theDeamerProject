...
#ifndef DEAMER_FILE_TOOL_ACTION_COMMAND_REMOVEFILE_H
#define DEAMER_FILE_TOOL_ACTION_COMMAND_REMOVEFILE_H
...
namespace deamer::file::tool::action
{
	...
	public:
		RemoveFile(const std::string& lhsPath_);
		virtual ~RemoveFile() override = default;
...
#endif // DEAMER_FILE_TOOL_ACTION_COMMAND_REMOVEFILE_H
