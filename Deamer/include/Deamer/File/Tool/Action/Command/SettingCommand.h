...
#ifndef DEAMER_FILE_TOOL_ACTION_COMMAND_SETTINGCOMMAND_H
#define DEAMER_FILE_TOOL_ACTION_COMMAND_SETTINGCOMMAND_H
...
namespace deamer::file::tool::action
{
	...
	public:
		SettingCommand(Setting setting_, const std::string& argument_);
		virtual ~SettingCommand() override = default;
...
#endif // DEAMER_FILE_TOOL_ACTION_COMMAND_SETTINGCOMMAND_H
