...
#ifndef DEAMER_FILE_TOOL_ACTION_COMMAND_CHANGEDIRECTORY_H
#define DEAMER_FILE_TOOL_ACTION_COMMAND_CHANGEDIRECTORY_H
...
namespace deamer::file::tool::action
{
	...
	public:
		ChangeDirectory(const std::string& lhsPath_);
		virtual ~ChangeDirectory() override = default;
...
#endif // DEAMER_FILE_TOOL_ACTION_COMMAND_CHANGEDIRECTORY_H
