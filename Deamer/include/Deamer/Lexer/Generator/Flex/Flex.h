...
#ifndef DEAMER_LEXER_GENERATOR_FLEX_H
#define DEAMER_LEXER_GENERATOR_FLEX_H

#include "Deamer/Language/Reference/PropertyDefinition.h"
#include "Deamer/Lexer/Generator/Base.h"

namespace deamer::lexer::generator::flex
{
	class Flex : public Base
	{
	public:
...
#endif // DEAMER_LEXER_GENERATOR_FLEX_H
