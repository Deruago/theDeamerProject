...
namespace deamer::language::generator::definition::property::standard
{
	...
	class Associativity : public Base<LanguageDefinitionType, type::definition::property::main::Associativity, type::definition::property::main::Lexicon>
	{
	private:
		type::definition::object::main::AssociativityType associativityType;
	public:
		Associativity(LanguageDefinitionType* language_, type::definition::object::main::AssociativityType associativityType_ = type::definition::object::main::AssociativityType::any)
			:	standard::Base<LanguageDefinitionType, type::definition::property::main::Associativity, type::definition::property::main::Lexicon>(language_),
		...
		void GenerateObjects() override
		{
			...
			{
				auto* const newObject = new type::definition::object::main::ObjectAssociativity(terminal, associativityType);
		...
		{
			auto ObjectAssociativities = Base<LanguageDefinitionType, type::definition::property::main::Associativity, type::definition::property::main::Lexicon>::template GetObjects<type::definition::object::Type::ObjectAssociativity>();
			this->generatedDefinition = new type::definition::property::main::Associativity(ObjectAssociativities);
		}
	};
}
