...
#ifndef DEAMER_LANGUAGE_DATASTRUCTURE_DEFINITION_OBJECT_MAIN_THREAT_CHECK_MULTI_MULTI_H
#define DEAMER_LANGUAGE_DATASTRUCTURE_DEFINITION_OBJECT_MAIN_THREAT_CHECK_MULTI_MULTI_H
...
namespace deamer::language::type::definition::object::main::threat::check
{
	 ...
	 *
	 *  \note Single checks may still use reverse lookup for more than this LPD.
	 *
	 *  \tparam T The LPD it targets.
	 */
	template<const type::definition::property::Type... Ts>
	class Multi : public Check
	{
	public:
		using PropertyReference = reference::PropertyDefinition<Ts...>;

	public:
		virtual ~Multi() override = default;
...
#endif // DEAMER_LANGUAGE_DATASTRUCTURE_DEFINITION_OBJECT_MAIN_THREAT_CHECK_MULTI_MULTI_H
