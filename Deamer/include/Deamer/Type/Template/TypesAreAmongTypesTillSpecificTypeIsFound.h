...
namespace deamer::type
{
	 ...
	 *
	 *	\brief This class can be used to check whether a set of types, are in another set of types. Until a given type is found.
	 *
	 ...
	 *
	 *	You can input a specific type, that stops the search. If not every type is found, the function will return false.
	 *
	...
	private:
		...
		{
			if constexpr (TypeIsAmongTypesTillSpecificTypeIsFound<DeadType, CheckType_, Ts...>::value)
			{
