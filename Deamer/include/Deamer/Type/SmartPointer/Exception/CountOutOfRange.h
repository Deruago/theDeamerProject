...
#ifndef DEAMER_TYPE_SMARTPOINTER_EXCEPTION_COUNTOUTOFRANGE_H
#define DEAMER_TYPE_SMARTPOINTER_EXCEPTION_COUNTOUTOFRANGE_H
...
#endif //DEAMER_TYPE_SMARTPOINTER_EXCEPTION_COUNTOUTOFRANGE_H
