...
#ifndef DEAMER_PARSER_TYPE_BISON_ASSOCIATIVITYSECTION_H
...
{
	class AssociativitySection : public file::tool::Data
	{
	private:
...
#endif // DEAMER_PARSER_TYPE_BISON_ASSOCIATIVITYSECTION_H
