...
#ifndef DEAMER_PARSER_TYPE_DPARSE_PARSERDEFINITION_H
#define DEAMER_PARSER_TYPE_DPARSE_PARSERDEFINITION_H
...
#endif // DEAMER_PARSER_TYPE_DPARSE_PARSERDEFINITION_H
