#ifndef DLDL_GRAMMAR_DEFINITION_GENERATION_H
#define DLDL_GRAMMAR_DEFINITION_GENERATION_H
...
namespace DLDL::grammar
{
	...
	public:
		Generation(DLDL::grammar::Language* language)
...
#endif // DLDL_GRAMMAR_DEFINITION_GENERATION_H
