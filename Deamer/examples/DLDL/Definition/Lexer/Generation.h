#ifndef DLDL_LEXER_DEFINITION_GENERATION_H
#define DLDL_LEXER_DEFINITION_GENERATION_H
...
namespace DLDL::lexer
{
	...
	public:
		Generation(DLDL::lexer::Language* language)
...
#endif // DLDL_LEXER_DEFINITION_GENERATION_H
