#ifndef DST_SETTING_DEFINITION_GENERATION_H
#define DST_SETTING_DEFINITION_GENERATION_H
...
namespace DST::setting
{
	...
	public:
		Generation(DST::setting::Language* language)
...
#endif // DST_SETTING_DEFINITION_GENERATION_H
